...
TEXT ·installeraidt(SB),NOSPLIT,$0
...
// used).
TEXT ·HandtagAvbrott(SB),NOSPLIT,$0-10
	...
	LEAQ ·avbrottgatepost(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchAvbrott(SB),NOSPLIT,$0
...
TEXT ·avbrottgatepost(SB),NOSPLIT,$0
