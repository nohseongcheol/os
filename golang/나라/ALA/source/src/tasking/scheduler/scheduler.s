...
TEXT ·Avaktiveraint(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpAnvändarlägeiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpAnvändarlägeiret1(SB),NOSPLIT,$0
	RET

TEXT ·threadAvslutaSlinga(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·återställfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
