...
TEXT ·InhabilitaEnter(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpModedusuariiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpModedusuariiret1(SB),NOSPLIT,$0
	RET

TEXT ·threadSurtloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·restaurafpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
