...
// used).
TEXT ·HandleԸնդհատել(SB),NOSPLIT,$0-10
	...
	LEAQ ·ընդհատելgateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchԸնդհատել(SB),NOSPLIT,$0
...
TEXT ·ընդհատելgateentry(SB),NOSPLIT,$0
