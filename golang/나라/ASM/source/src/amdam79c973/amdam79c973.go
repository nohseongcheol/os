...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	Porttusiword(registeraddressport, 20)
	Porttusiword(buscontrolregisterdataport, 0x102)

	Porttusiword(registeraddressport, 0)
	Porttusiword(registerdataport, 0x04)
	...
	Porttusiword(registeraddressport, 1)
	Porttusiword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Porttusiword(registeraddressport, 2)
	Porttusiword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Porttusiword(registeraddressport, 0)
	Porttusiword(registerdataport, 0x41)

	Porttusiword(registeraddressport, 4)
	temporary := Portfaitauword(registerdataport)
	Porttusiword(registeraddressport, 4)
	Porttusiword(registerdataport, temporary|0xC00)

	Porttusiword(registeraddressport, 0)
	Porttusiword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portfaitauword(resetport)
	Porttusiword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Porttusiword(registeraddressport, 0)
	Porttusiword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Porttusiword(registeraddressport, 0)
	Porttusiword(registerdataport, 0x48)
