...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Porttusibyte(Primarypiccommandioport, 0x11)
	Porttusibyte(Secondarypiccommandioport, 0x11)

	Porttusibyte(Primarypicdataioport, 0x20)
	Porttusibyte(Secondarypicdataioport, 0x28)

	Porttusibyte(Primarypicdataioport, 0x04)
	Porttusibyte(Secondarypicdataioport, 0x02)

	Porttusibyte(Primarypicdataioport, 0x01)
	Porttusibyte(Secondarypicdataioport, 0x01)

	Porttusibyte(Primarypicdataioport, 0xF8)
	Porttusibyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Porttusibyte(Secondarypiccommandioport, 0x20)
		}
		Porttusibyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
