...
func (self *TPort8bit) Tusi(data uint8) {
...
func Porttusibyte(portnumber uint16, data uint8) {
...
func (self *TPort16bit) Tusi(data uint16) {
...
func Porttusiword(portnumber uint16, data uint16) {
