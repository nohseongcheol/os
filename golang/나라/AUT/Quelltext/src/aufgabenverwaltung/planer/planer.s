...
TEXT ·DeaktivierenGanzzahl(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpBenutzermodusiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpBenutzermodusiret1(SB),NOSPLIT,$0
	RET

TEXT ·ausführungsfadenBeendenSchleife(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·wiederherstellenfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
