# Azerbaijan (AZE) source language

- country: Azerbaijan (AZ)
- selected language: az_Latn
- CLDR population: 89%
- official status: official
- native language name: Azerbaijani
- target-language vocabulary: 95
- unresolved source-glossary vocabulary: 776
