...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portkwandikabyte(Primarypiccommandioport, 0x11)
	Portkwandikabyte(Secondarypiccommandioport, 0x11)

	Portkwandikabyte(Primarypicdataioport, 0x20)
	Portkwandikabyte(Secondarypicdataioport, 0x28)

	Portkwandikabyte(Primarypicdataioport, 0x04)
	Portkwandikabyte(Secondarypicdataioport, 0x02)

	Portkwandikabyte(Primarypicdataioport, 0x01)
	Portkwandikabyte(Secondarypicdataioport, 0x01)

	Portkwandikabyte(Primarypicdataioport, 0xF8)
	Portkwandikabyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portkwandikabyte(Secondarypiccommandioport, 0x20)
		}
		Portkwandikabyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
