...
TEXT ·installerenidt(SB),NOSPLIT,$0
...
// used).
TEXT ·Handgreepinterrupt(SB),NOSPLIT,$0-10
	...
	LEAQ ·interruptgateItem(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
TEXT ·interruptgateItem(SB),NOSPLIT,$0
