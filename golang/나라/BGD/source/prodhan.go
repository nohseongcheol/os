...
func (self *TMykeyboardeventhandler) Onkeyউপর(key byte)	{}
...
func (self *TMymouseeventhandler) Onmouseউপর(button int8)	{}
...
func KKernelEntry(Pagedirectoryentry uintptr, stacktop uintptr, stackbottom uintptr) {
	...
	Porafile(linkerfile, linkerdata)
