...
func (self_2 *TSegmentdescriptor) Init(base_2 uint32, limit_2 uint32, ধরণ uint8, flags_2 uint8) {
...
func (self_2 *TShareddescriptortable) Setdescriptor(idx int, base_2 uint32, limit_2 uint32, ধরণ uint8, flags_2 uint8) {
	data_2.segmentdescriptor[idx].Init(base_2, limit_2, ধরণ, flags_2)
}
