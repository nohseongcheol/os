...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portlekhabyte(Primarypiccommandioport, 0x11)
	Portlekhabyte(Secondarypiccommandioport, 0x11)

	Portlekhabyte(Primarypicdataioport, 0x20)
	Portlekhabyte(Secondarypicdataioport, 0x28)

	Portlekhabyte(Primarypicdataioport, 0x04)
	Portlekhabyte(Secondarypicdataioport, 0x02)

	Portlekhabyte(Primarypicdataioport, 0x01)
	Portlekhabyte(Secondarypicdataioport, 0x01)

	Portlekhabyte(Primarypicdataioport, 0xF8)
	Portlekhabyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Interruptdescriptortableentryset(interrupt int,
	...
	(*access) = (Idtdescriptorpresent | Descriptorধরণ | ((Descriptorprivilegelevel & 3) << 5))
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portlekhabyte(Secondarypiccommandioport, 0x20)
		}
		Portlekhabyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
