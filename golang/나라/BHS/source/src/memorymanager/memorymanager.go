...
func (self *TMemorymanager) Allocate_memory(size uint32) Pointer {
...
func (self *TMemorymanager) Free(address_reference_2 Pointer) {
	var chunk *TMemorychunk = (*TMemorychunk)(Pointer(uintptr(address_reference_2) - uintptr(memorychunksize)))
...
func New(size int) Pointer {
	...
	return Activememorymanager.Allocate_memory(uint32(size))
}
func Delete(address_reference_2 Pointer) {
	if Activememorymanager != nil {
		Activememorymanager.Free(address_reference_2)
	}
}
