...
func (self *Processhelper) Create(unospoint func(), threadhelper *TThreadhelper, StranicaDirektorijunos uint32, iskernel bool) Process {
	...
	главниthread := threadhelper.CreatepointerfromFunkcija(unospoint, StranicaDirektorijunos, iskernel)
	if главниthread != nil {
		главниthread.Pid = process.id
		главниthread.Parentpid = 0
		process.Threads.Append_to_list(uintptr(Pointer(главниthread)))
	}
