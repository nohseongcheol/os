...
TEXT ·Desativarint(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpMododeutilizadoriret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpMododeutilizadoriret1(SB),NOSPLIT,$0
	RET

TEXT ·fluxoExecuçãoSairloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·restaurarfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
