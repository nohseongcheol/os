# Brunei Darussalam (BRN) source language

- country: Brunei Darussalam (BN)
- selected language: ms_Latn
- CLDR population: 93%
- official status: official
- native language name: Malay (macrolanguage)
- target-language vocabulary: 198
- unresolved source-glossary vocabulary: 673
