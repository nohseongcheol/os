# Curaçao (CUW) source language

- country: Curaçao (CW)
- selected language: pap
- CLDR population: 81%
- official status: de_facto_official
- native language name: Papiamento
- target-language vocabulary: 3
- unresolved source-glossary vocabulary: 868
