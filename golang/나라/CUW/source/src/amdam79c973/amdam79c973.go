...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	Portskirbiword(registeraddressport, 20)
	Portskirbiword(buscontrolregisterdataport, 0x102)

	Portskirbiword(registeraddressport, 0)
	Portskirbiword(registerdataport, 0x04)
	...
	Portskirbiword(registeraddressport, 1)
	Portskirbiword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Portskirbiword(registeraddressport, 2)
	Portskirbiword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Portskirbiword(registeraddressport, 0)
	Portskirbiword(registerdataport, 0x41)

	Portskirbiword(registeraddressport, 4)
	temporary := Portlesaword(registerdataport)
	Portskirbiword(registeraddressport, 4)
	Portskirbiword(registerdataport, temporary|0xC00)

	Portskirbiword(registeraddressport, 0)
	Portskirbiword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portlesaword(resetport)
	Portskirbiword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Portskirbiword(registeraddressport, 0)
	Portskirbiword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Portskirbiword(registeraddressport, 0)
	Portskirbiword(registerdataport, 0x48)
