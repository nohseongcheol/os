...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portskirbibyte(Primarypiccommandioport, 0x11)
	Portskirbibyte(Secondarypiccommandioport, 0x11)

	Portskirbibyte(Primarypicdataioport, 0x20)
	Portskirbibyte(Secondarypicdataioport, 0x28)

	Portskirbibyte(Primarypicdataioport, 0x04)
	Portskirbibyte(Secondarypicdataioport, 0x02)

	Portskirbibyte(Primarypicdataioport, 0x01)
	Portskirbibyte(Secondarypicdataioport, 0x01)

	Portskirbibyte(Primarypicdataioport, 0xF8)
	Portskirbibyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portskirbibyte(Secondarypiccommandioport, 0x20)
		}
		Portskirbibyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
