...
func (self *TPeripheralcomponentinterconnectcontroller) Lesa(bus uint16, device_2 uint16, function uint16, registeroffset uint32) uint32 {
	...
	Portskirbidword(self.commandport, id)
...
func (self *TPeripheralcomponentinterconnectcontroller) Skirbi(bus uint16, device_2 uint16, function uint16, registeroffset uint32, value uint32) {
	var id uint32
	id = 0x1<<31 | uint32((bus&0xFF)<<16) | uint32((device_2&0x1f)<<11) | uint32((function&0x07)<<8) | uint32(registeroffset&0xFC)
	Portskirbidword(self.commandport, id)
	Portskirbidword(self.dataport, value)
}
...
func (self *TPeripheralcomponentinterconnectcontroller) Getdevicedescriptor(bus uint16, device_2 uint16, function uint16) TPeripheralcomponentinterconnectdevicedescriptor {
	...
	result.interfaceid = uint8(self.Lesa(bus, device_2, function, 0x09))
