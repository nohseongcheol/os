...
func (self *TPort8bit) Skirbi(data uint8) {
...
func Portskirbibyte(portnumber uint16, data uint8) {
...
func (self *TPort16bit) Skirbi(data uint16) {
...
func Portskirbiword(portnumber uint16, data uint16) {
