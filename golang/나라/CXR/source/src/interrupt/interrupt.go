...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portwritebyte(Primarypiccommandioport, 0x11)
	Portwritebyte(Secondarypiccommandioport, 0x11)

	Portwritebyte(Primarypicdataioport, 0x20)
	Portwritebyte(Secondarypicdataioport, 0x28)

	Portwritebyte(Primarypicdataioport, 0x04)
	Portwritebyte(Secondarypicdataioport, 0x02)

	Portwritebyte(Primarypicdataioport, 0x01)
	Portwritebyte(Secondarypicdataioport, 0x01)

	Portwritebyte(Primarypicdataioport, 0xF8)
	Portwritebyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portwritebyte(Secondarypiccommandioport, 0x20)
		}
		Portwritebyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
