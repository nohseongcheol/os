...
TEXT ·instalovatidt(SB),NOSPLIT,$0
...
// used).
TEXT ·ÚchytkaPřerušení(SB),NOSPLIT,$0-10
	...
	LEAQ ·přerušenígateZáznam(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchPřerušení(SB),NOSPLIT,$0
...
TEXT ·přerušenígateZáznam(SB),NOSPLIT,$0
