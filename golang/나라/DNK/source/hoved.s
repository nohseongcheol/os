...
TEXT ·getgs(SB),NOSPLIT,$0
	MOVW GS, ret+4(FP)
	RET
TEXT ·PauseLøkkekolonier(SB), NOSPLIT, $0
	PAUSE_LOOP:
	MOVL $0x1, AX
	CMPL AX, $0x1
	JE PAUSE_LOOP
...
TEXT ·Genindlæscr3(SB),NOSPLIT,$0
	MOVL CR3, AX
	MOVL AX, CR3
	MOVL AX, ret+0(FP)
	RET
...
TEXT ·Getcr4(SB),NOSPLIT,$0
	...
	MOVL AX, ret+0(FP)
	RET
TEXT ·Aktiverpaging(SB),NOSPLIT,$0
    MOVL CR0, AX
    ORL $0x80000001, AX
    MOVL AX, CR0
    RET
