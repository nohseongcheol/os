...
TEXT ·installéridt(SB),NOSPLIT,$0
...
// used).
TEXT ·Håndtaginterrupt(SB),NOSPLIT,$0-10
	...
	LEAQ ·interruptgateemne(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
TEXT ·interruptgateemne(SB),NOSPLIT,$0
