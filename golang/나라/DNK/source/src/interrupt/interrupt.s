...
TEXT ·haltEfterfatalexception(SB),NOSPLIT,$0
	CLI
...
TEXT ·InterruptAktiv(SB),NOSPLIT,$0
	STI
	RET
...
TEXT ·interruptAfslutLøkkekolonier(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
