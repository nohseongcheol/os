...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Porttsahafbyte(Primarypiccommandioport, 0x11)
	Porttsahafbyte(Secondarypiccommandioport, 0x11)

	Porttsahafbyte(Primarypicdataioport, 0x20)
	Porttsahafbyte(Secondarypicdataioport, 0x28)

	Porttsahafbyte(Primarypicdataioport, 0x04)
	Porttsahafbyte(Secondarypicdataioport, 0x02)

	Porttsahafbyte(Primarypicdataioport, 0x01)
	Porttsahafbyte(Secondarypicdataioport, 0x01)

	Porttsahafbyte(Primarypicdataioport, 0xF8)
	Porttsahafbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Porttsahafbyte(Secondarypiccommandioport, 0x20)
		}
		Porttsahafbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
