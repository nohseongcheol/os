...
// used).
TEXT ·HandleKatkestus(SB),NOSPLIT,$0-10
	...
	LEAQ ·katkestusgatekirje(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchKatkestus(SB),NOSPLIT,$0
...
TEXT ·katkestusgatekirje(SB),NOSPLIT,$0
