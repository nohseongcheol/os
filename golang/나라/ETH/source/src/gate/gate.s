...
GLOBL ·መለያ_2tDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·መለያ_2t<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
TEXT ·መግጠምidt(SB),NOSPLIT,$0
	LEAQ ·መለያ_2tDescriptor<>(SB), AX
...
// used).
TEXT ·Handleማቋረጫ(SB),NOSPLIT,$0-10
	...
	LEAQ ·ማቋረጫgateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchማቋረጫ(SB),NOSPLIT,$0
...
TEXT ·ማቋረጫgateentry(SB),NOSPLIT,$0
