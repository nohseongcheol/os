...
var tssማውጫ uint32 = 0
var flushማውጫ uint32 = 0

func flushtss(uint32)
func (self *Tssentry) Iመግጠም(gdt *TShareddescriptorሰንጠረዥ, idx int, kernelss uint32, kernelesp uint32) {

	console_2.Mማተሚያxy(([]byte)("tss:"), 20, 13)
	base := uint32(uintptr(Pointer(self)))
	console_2.MUnsignedinteger32ማተሚያ(base)
	console_2.Mማተሚያ(":")
