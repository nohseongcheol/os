# Faroe Islands (FRO) source language

- country: Faroe Islands (FO)
- selected language: fo
- CLDR population: 95%
- official status: official
- native language name: Faroese
- target-language vocabulary: 47
- unresolved source-glossary vocabulary: 824
