...
func Serialinit()
func Serialskrivabyte(data uint8)
...
func (self *TConsole) MPrintxy(temporary_2 interface{}, x uint16, y uint16) {
	...
	case string:
		...
		self.MPrintbýtxy(([]byte)(data_2), x, y)
	case uint8:
	...
	default:
		...
		self.MPrintbýtxy(data_2, x, y)
	}

}
func (self *TConsole) MPrintbýtxy(buffer []byte, x uint16, y uint16) {
