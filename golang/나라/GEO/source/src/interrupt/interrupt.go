...
func Testბეჭდვა(position uint8, data uint8)
func setds(dssegment uint32)
func setgs(gssegment uint32)
func interruptგასვლაloop()

type TInterrupthandler struct {
	Interruptრიცხვი		uint8
...
func Nახალიinterrupthandler(Interruptmanager uintptr, Interruptრიცხვი uint8) *TInterrupthandler {
	interrupthandler_2 := new(TInterrupthandler)
	interrupthandler_2.Interruptრიცხვი = Interruptრიცხვი
...
func (self *TInterrupthandler) Init(Interruptრიცხვი uint8, Interruptmanager uintptr, funcaddress uintptr) {

	handler_2[Interruptრიცხვი] = funcaddress

	self.Interruptრიცხვი = Interruptრიცხვი
	self.Interruptmanager = Interruptmanager

}
func (self *TInterrupthandler) Sethandleinterruptfuction(Interruptრიცხვი uint32, address uintptr) {
	handler_2[Interruptრიცხვი] = address
}
func (self *TInterrupthandler) Destroy() {
	...
	if selfuintptr == Interruptmanager.Gethandler(self.Interruptრიცხვი) {
		Interruptmanager.Sethandler(0, self.Interruptრიცხვი)
	}

}
func (self *TInterrupthandler) Setinterruptmanager(Interruptmanager uintptr) {
}
func (self *TInterrupthandler) Setinterruptრიცხვი(Interruptრიცხვი uint8) {
	self.Interruptრიცხვი = Interruptრიცხვი
}
...
type TInterruptdescriptorცხრილიკურსორი struct {
}

var idtdata [256 * 8]uint8
var Aაქტიურიinterruptmanager uintptr = 0
...
type TInterruptmanager struct {
	...
	აპარატურაinterruptoffset	uint16

	taskmanager	*TTaskmanager
}

var Primarypicბრძანებაioპორტი uint16 = 0x20
var Primarypicdataioპორტი uint16 = 0x21
var Secondarypicბრძანებაioპორტი uint16 = 0xA0
var Secondarypicdataioპორტი uint16 = 0xA1

func (self *TInterruptmanager) Init(აპარატურაinterruptoffset uint16, globaldescriptorცხრილი *TShareddescriptorცხრილი, taskmanager *TTaskmanager) {

	self.taskmanager = taskmanager

	self.აპარატურაinterruptoffset = აპარატურაinterruptoffset
	...
	for i := 0; i < 256; i++ {
		...
		self.Interruptdescriptorცხრილიentryset(i, codesegment, address, 0, Idtinterruptgate)
	}

	address = uint32(ValueOf(interruptexceptionhandler0x00).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x00, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x01).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x01, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x02).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x02, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x03).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x03, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x04).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x04, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x05).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x05, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x06).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x06, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x07).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x07, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x08).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x08, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x09).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x09, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0a).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x0A, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0b).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x0B, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x0c).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x0C, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x0d).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x0D, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0e).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x0E, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0f).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x0F, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x10).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x10, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x11).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x11, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x12).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x12, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x13).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x13, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x00).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x20, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x01).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x21, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x02).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x22, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x03).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x23, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x04).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x24, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x05).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x25, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x06).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x26, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x07).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x27, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x08).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x28, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x09).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x29, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0a).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x2A, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0b).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x2B, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0c).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x2C, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0d).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x2D, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0e).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x2E, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0f).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x2F, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x80).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x80, codesegment, address, 3, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x81).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x81, codesegment, address, 3, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x82).Pointer())
	self.Interruptdescriptorცხრილიentryset(0x82, codesegment, address, 3, Idtinterruptgate)

	Pპორტიჩაწერაbyte(Primarypicბრძანებაioპორტი, 0x11)
	Pპორტიჩაწერაbyte(Secondarypicბრძანებაioპორტი, 0x11)

	Pპორტიჩაწერაbyte(Primarypicdataioპორტი, 0x20)
	Pპორტიჩაწერაbyte(Secondarypicdataioპორტი, 0x28)

	Pპორტიჩაწერაbyte(Primarypicdataioპორტი, 0x04)
	Pპორტიჩაწერაbyte(Secondarypicdataioპორტი, 0x02)

	Pპორტიჩაწერაbyte(Primarypicdataioპორტი, 0x01)
	Pპორტიჩაწერაbyte(Secondarypicdataioპორტი, 0x01)

	Pპორტიჩაწერაbyte(Primarypicdataioპორტი, 0xF8)
	Pპორტიჩაწერაbyte(Secondarypicdataioპორტი, 0xEF)

	idtკურსორი := [6]uint8{0, 0, 0, 0, 0, 0}
	ზომა := (*uint16)(Pointer(&idtკურსორი[0]))
	(*ზომა) = (uint16)(Sizeof(idtdata) - 1)

	base := (*uint32)(Pointer(&idtკურსორი[2]))
	(*base) = uint32(uintptr(Pointer(&idtdata)))

	Lidt(uintptr(Pointer(&idtკურსორი)))
}
func Lidt(lidtaddr uintptr)

func (self *TInterruptmanager) Interruptdescriptorცხრილიentryset(interrupt int,
	codesegment uint16,
	handler uint32,
	Descriptorprivilegelevel uint8,
	Descriptorტიპი uint8) {
	...
	წვდომა := (*uint8)(Pointer(&idtdata[interrupt*8+5]))
	(*წვდომა) = (Idtdescriptorpresent | Descriptorტიპი | ((Descriptorprivilegelevel & 3) << 5))
...
func (self *TInterruptmanager) Sethandler(handler uintptr, Interruptრიცხვი uint8) {
	handler_2[Interruptრიცხვი] = handler
}
func (self *TInterruptmanager) Gethandler(Interruptრიცხვი uint8) uintptr {
	return handler_2[Interruptრიცხვი]
}
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {

	if interruptdebug {
		console_2.Mბეჭდვაxy("[esp:", 1, 20)
		console_2.MUnsignedinteger32ბეჭდვა(uint32(interrupt))
		console_2.Mბეჭდვა(":")
		console_2.MUnsignedinteger32ბეჭდვა(esp)
	}
	handlerგაშვება := false
	...
	if !handlerგაშვება && interrupt == uint8(self.აპარატურაinterruptoffset) && self.taskmanager != nil {
		esp = uint32(uintptr(Pointer(self.taskmanager.Schedule((*Tcpustate)(Pointer(uintptr(esp)))))))

	}
	if !handlerგაშვება && interrupt == 0x80 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Pპორტიჩაწერაbyte(Secondarypicბრძანებაioპორტი, 0x20)
		}
		Pპორტიჩაწერაbyte(Primarypicბრძანებაioპორტი, 0x20)
	}
	return esp
}
...
func Handleinterrupt(esp uint32, interrupt uint32) uint32 {
	...
	if interruptdebug && interrupt != 0x80 && interrupt != 0x20 {
		console_2.Mბეჭდვაxy("[esp:", 1, 21)
		console_2.MUnsignedinteger32ბეჭდვა(uint32(interrupt))
		console_2.Mბეჭდვა(":")
		console_2.MUnsignedinteger32ბეჭდვა(esp)
	}

	if Aაქტიურიinterruptmanager != 0 {
		p := (*TInterruptmanager)(Pointer(Aაქტიურიinterruptmanager))
...
func handleunhandledsyscall(esp uint32) uint32 {
	...
	if cpu.Eax == 1 || cpu.Eax == 252 {
		cpu.Eip = uint32(ValueOf(interruptგასვლაloop).Pointer())
...
func exceptionhasშეცდომაcode(interrupt uint32) bool {
	switch interrupt {
...
func exceptionსახელი(interrupt uint32) string {
	switch interrupt {
	case 0x00:
...
func exceptionframeმნიშვნელობა(frame uint32, offset uint32) uint32 {
...
func ბეჭდვაგვერდიfaultinfo(err uint32) {
...
func ბეჭდვაexceptionselectorinfo(err uint32) {
...
func Handleexception(esp uint32, interrupt uint32) uint32 {
	...
	if exceptionhasშეცდომაcode(interrupt) {
		err = exceptionframeმნიშვნელობა(esp, 0)
		eipoffset = 4
	}
	eip := exceptionframeმნიშვნელობა(esp, eipoffset)
	cs := exceptionframeმნიშვნელობა(esp, eipoffset+4)
	eflags := exceptionframeმნიშვნელობა(esp, eipoffset+8)
	...
	if interrupt == 0x0E {
		...
		ბეჭდვაგვერდიfaultinfo(err)
	}

	if (cs & 0x03) != 0 {
		MEmergencylogstring(" useresp=")
		MEmergencylogunsignedinteger32(exceptionframeმნიშვნელობა(esp, eipoffset+12))
		MEmergencylogstring(" ss=")
		MEmergencylogunsignedinteger32(exceptionframeმნიშვნელობა(esp, eipoffset+16))
	}

	if exceptionhasშეცდომაcode(interrupt) {
		ბეჭდვაexceptionselectorinfo(err)
	}
	MEmergencylogstring("\n=== ENGOS HALTED AFTER EXCEPTION ===\n")
	except++
...
func Interruptაქტიური()
func (self *TInterruptmanager) Aაქტიური() {
	if Aაქტიურიinterruptmanager != 0 {
		self.Deactive()
	}
	address := uintptr(Pointer(self))
	Aაქტიურიinterruptmanager = address
	Interruptაქტიური()
}
func Interruptdeactive()
func (self *TInterruptmanager) Deactive() {
	Aაქტიურიinterruptmanager = 0
	Interruptdeactive()
}
...
func interrupthandler_2(interrupt uint8, esp uint32) uint32 {
	...
	console_2 := TConsole{}
	console_2.Mბეჭდვა(buffer)
	console_2.MHexadecimalბეჭდვა(0x40)
	return esp
}
func ბეჭდვაesp(esp uint32) {
	console_2 := TConsole{}
	console_2.MUnsignedinteger32ბეჭდვაxy(esp, 20, 21)
}
func gettls() uint32
func Pბეჭდვაtls() {
