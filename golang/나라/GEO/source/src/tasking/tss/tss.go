...
var tssინდექსი uint32 = 0
var flushინდექსი uint32 = 0

func flushtss(uint32)
func (self *Tssentry) Iდაყენება(gdt *TShareddescriptorცხრილი, idx int, kernelss uint32, kernelesp uint32) {

	console_2.Mბეჭდვაxy(([]byte)("tss:"), 20, 13)
	base := uint32(uintptr(Pointer(self)))
	console_2.MUnsignedinteger32ბეჭდვა(base)
	console_2.Mბეჭდვა(":")
