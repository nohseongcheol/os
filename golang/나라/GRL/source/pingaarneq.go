...
func KKernelEntry(Pagedirectoryentry uintptr, stacktop uintptr, stackbottom uintptr) {
	...
	Atuarneqfile(linkerfile, linkerdata)
	...
	Atuarneqfile(lib1file, lib1data)
	...
	Atuarneqfile(lib2file, lib2data)
	...
	Atuarneqfile(user1file, user1data)
	...
	*code1pointer = uintptr(linkerentry)
	...
	Atuarneqfile(user2file, user2data)
	...
	*code2pointer = uintptr(linkerentry)
	...
	Atuarneqfile(user3file, user3data)
