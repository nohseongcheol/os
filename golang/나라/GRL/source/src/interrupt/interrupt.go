...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portallanneqbyte(Primarypiccommandioport, 0x11)
	Portallanneqbyte(Secondarypiccommandioport, 0x11)

	Portallanneqbyte(Primarypicdataioport, 0x20)
	Portallanneqbyte(Secondarypicdataioport, 0x28)

	Portallanneqbyte(Primarypicdataioport, 0x04)
	Portallanneqbyte(Secondarypicdataioport, 0x02)

	Portallanneqbyte(Primarypicdataioport, 0x01)
	Portallanneqbyte(Secondarypicdataioport, 0x01)

	Portallanneqbyte(Primarypicdataioport, 0xF8)
	Portallanneqbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portallanneqbyte(Secondarypiccommandioport, 0x20)
		}
		Portallanneqbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
