...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	var Mac0 uint64 = uint64(Portliword(Macaddress0port) % 256)
	var Mac1 uint64 = uint64(Portliword(Macaddress0port) / 256)
	var Mac2 uint64 = uint64(Portliword(Macaddress2port) % 256)
	var Mac3 uint64 = uint64(Portliword(Macaddress2port) / 256)
	var Mac4 uint64 = uint64(Portliword(Macaddress4port) % 256)
	var Mac5 uint64 = uint64(Portliword(Macaddress4port) / 256)
	...
	Portekriword(registeraddressport, 20)
	Portekriword(buscontrolregisterdataport, 0x102)

	Portekriword(registeraddressport, 0)
	Portekriword(registerdataport, 0x04)
	...
	Portekriword(registeraddressport, 1)
	Portekriword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Portekriword(registeraddressport, 2)
	Portekriword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Portekriword(registeraddressport, 0)
	Portekriword(registerdataport, 0x41)

	Portekriword(registeraddressport, 4)
	temporary := Portliword(registerdataport)
	Portekriword(registeraddressport, 4)
	Portekriword(registerdataport, temporary|0xC00)

	Portekriword(registeraddressport, 0)
	Portekriword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portliword(resetport)
	Portekriword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Portekriword(registeraddressport, 0)
	temporary := uint32(Portliword(registerdataport))
	...
	Portekriword(registeraddressport, 0)
	Portekriword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Portekriword(registeraddressport, 0)
	Portekriword(registerdataport, 0x48)
