...
func (self *Memoryoper) Memmove(destinationpointer_2 uintptr, srcptr uintptr, size uint32) uintptr {
	return destinationpointer_2
}

func (self *Memoryoper) Memcopy(destinationpointer_2 uintptr, srcptr uintptr, size uint32) uintptr {
	return destinationpointer_2
}
