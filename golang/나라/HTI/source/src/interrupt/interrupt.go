...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portekribyte(Primarypiccommandioport, 0x11)
	Portekribyte(Secondarypiccommandioport, 0x11)

	Portekribyte(Primarypicdataioport, 0x20)
	Portekribyte(Secondarypicdataioport, 0x28)

	Portekribyte(Primarypicdataioport, 0x04)
	Portekribyte(Secondarypicdataioport, 0x02)

	Portekribyte(Primarypicdataioport, 0x01)
	Portekribyte(Secondarypicdataioport, 0x01)

	Portekribyte(Primarypicdataioport, 0xF8)
	Portekribyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portekribyte(Secondarypiccommandioport, 0x20)
		}
		Portekribyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
