...
TEXT ·LetiltvaEgész(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpFelhasználóiüzemmódiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpFelhasználóiüzemmódiret1(SB),NOSPLIT,$0
	RET

TEXT ·threadKilépésHurok(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·helyreállításfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
