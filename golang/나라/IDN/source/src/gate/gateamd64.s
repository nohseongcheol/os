...
// used).
TEXT ·PenangananInterupsi(SB),NOSPLIT,$0-10
	...
	LEAQ ·interupsigateentri(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchInterupsi(SB),NOSPLIT,$0
...
TEXT ·interupsigateentri(SB),NOSPLIT,$0
