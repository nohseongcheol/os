...
func (self *TMykeyboardeventhandler) Onkeyऊपर(key byte)	{}
...
func (self *TMymouseeventhandler) Onmouseऊपर(button int8)	{}
...
var उपकरणdescriptor TPeripheralcomponentinterconnectउपकरणdescriptor
...
func (self TMypcicontrollerhandler) Ongetdriver(उपकरण TPeripheralcomponentinterconnectउपकरणdescriptor) {
	if उपकरण.Vendorid == 0x1022 && उपकरण.Dउपकरणid == 0x2000 {
		console.MPrintxy([]byte("["), 0, 12)
		console.MPrint(([]byte)("AMD am79c973"))
		console.MPrint([]byte(":"))
		console.MUnsignedinteger16print(उपकरण.Vendorid)
		console.MPrint([]byte(":"))
		console.MUnsignedinteger16print(उपकरण.Dउपकरणid)
		console.MPrint([]byte(":"))
		console.MUnsignedinteger16print(uint16(उपकरण.Portbase))
		console.MPrint([]byte(":"))
		console.MUnsignedinteger32print(उपकरण.Interrupt)

		console.MPrint([]byte("]\n"))
		उपकरणdescriptor = उपकरण
		drivercount++
	}
}
func (self TMypcicontrollerhandler) Getdriver() TPeripheralcomponentinterconnectउपकरणdescriptor {
	return उपकरणdescriptor
}
...
func KKernelEntry(Pagedirectoryentry uintptr, stacktop uintptr, stackbottom uintptr) {
	...
	Padhnafile(linkerfile, linkerdata)
	...
	Padhnafile(user1file, user1data)
	...
	*code1pointer = uintptr(linkerentry)
	...
	Padhnafile(user2file, user2data)
	...
	*code2pointer = uintptr(linkerentry)
	...
	Padhnafile(user3file, user3data)
	...
	*code3pointer = uintptr(linkerentry)
	...
	उपकरणdescriptor = mypcicontrollerhandler.Getdriver()
