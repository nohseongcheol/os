...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portlikhnabyte(Primarypiccommandioport, 0x11)
	Portlikhnabyte(Secondarypiccommandioport, 0x11)

	Portlikhnabyte(Primarypicdataioport, 0x20)
	Portlikhnabyte(Secondarypicdataioport, 0x28)

	Portlikhnabyte(Primarypicdataioport, 0x04)
	Portlikhnabyte(Secondarypicdataioport, 0x02)

	Portlikhnabyte(Primarypicdataioport, 0x01)
	Portlikhnabyte(Secondarypicdataioport, 0x01)

	Portlikhnabyte(Primarypicdataioport, 0xF8)
	Portlikhnabyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portlikhnabyte(Secondarypiccommandioport, 0x20)
		}
		Portlikhnabyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
