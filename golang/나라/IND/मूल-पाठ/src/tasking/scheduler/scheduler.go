...
func Currentजनकpid() uint32 {
	if schedata.currentthread == nil {
		return 0
	}
	return schedata.currentthread.Pजनकpid
}
...
func initpit(frequency uint32) {
	...
	Portlikhnabyte(0x43, 0x36)
	Portlikhnabyte(0x40, uint8(divisor&0xFF))
	Portlikhnabyte(0x40, uint8((divisor>>8)&0xFF))
}
