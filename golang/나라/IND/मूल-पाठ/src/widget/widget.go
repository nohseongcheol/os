...
type IWidget interface {
	Init(जनक IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
...
func (self *TWidget) Init(जनक IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Draw(vga *TVideographicsarray) {
	vga.Fillआयत(self.x, self.y, self.w, self.h, uint8(self.r), uint8(self.g), uint8(self.b))
}
...
func (self *TWidgetmouseeventhandler) Onmouseऊपर(button int8) {
}
