...
GLOBL ·מזהה_2tDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·מזהה_2t<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
TEXT ·התקנהidt(SB),NOSPLIT,$0
	LEAQ ·מזהה_2tDescriptor<>(SB), AX
...
TEXT ·Hידיתפסק(SB),NOSPLIT,$0-10
	...
	LEAQ ·פסקgateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
TEXT ·פסקgateentry(SB),NOSPLIT,$0
