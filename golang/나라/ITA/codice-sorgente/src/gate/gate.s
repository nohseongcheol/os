...
// used).
TEXT ·Manigliainterrupt(SB),NOSPLIT,$0-10
	...
	LEAQ ·interruptgatevoce(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
TEXT ·interruptgatevoce(SB),NOSPLIT,$0
