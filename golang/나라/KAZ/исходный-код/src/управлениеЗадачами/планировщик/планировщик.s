...
TEXT ·ОтключитьЦелое(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpПользовательскийрежимiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpПользовательскийрежимiret1(SB),NOSPLIT,$0
	RET

TEXT ·потокВыходloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·восстановитьfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
