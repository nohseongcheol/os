...
var tssМазмун uint32 = 0
var flushМазмун uint32 = 0

func flushtss(uint32)
func (self *Tssentry) Орнотуу(gdt *TShareddescriptorЖадыбал, idx int, kernelss uint32, kernelesp uint32) {

	console_2.MБасмаxy(([]byte)("tss:"), 20, 13)
	base := uint32(uintptr(Pointer(self)))
	console_2.MUnsignedinteger32Басма(base)
	console_2.MБасма(":")
