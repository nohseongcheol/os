...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	var Mac0 uint64 = uint64(Portaanword(Macaddress0port) % 256)
	var Mac1 uint64 = uint64(Portaanword(Macaddress0port) / 256)
	var Mac2 uint64 = uint64(Portaanword(Macaddress2port) % 256)
	var Mac3 uint64 = uint64(Portaanword(Macaddress2port) / 256)
	var Mac4 uint64 = uint64(Portaanword(Macaddress4port) % 256)
	var Mac5 uint64 = uint64(Portaanword(Macaddress4port) / 256)
	...
	Portsaseword(registeraddressport, 20)
	Portsaseword(buscontrolregisterdataport, 0x102)

	Portsaseword(registeraddressport, 0)
	Portsaseword(registerdataport, 0x04)
	...
	Portsaseword(registeraddressport, 1)
	Portsaseword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Portsaseword(registeraddressport, 2)
	Portsaseword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Portsaseword(registeraddressport, 0)
	Portsaseword(registerdataport, 0x41)

	Portsaseword(registeraddressport, 4)
	temporary := Portaanword(registerdataport)
	Portsaseword(registeraddressport, 4)
	Portsaseword(registerdataport, temporary|0xC00)

	Portsaseword(registeraddressport, 0)
	Portsaseword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portaanword(resetport)
	Portsaseword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Portsaseword(registeraddressport, 0)
	temporary := uint32(Portaanword(registerdataport))
	...
	Portsaseword(registeraddressport, 0)
	Portsaseword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Portsaseword(registeraddressport, 0)
	Portsaseword(registerdataport, 0x48)
