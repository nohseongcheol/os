...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, សកលdescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portsasebyte(Primarypiccommandioport, 0x11)
	Portsasebyte(Secondarypiccommandioport, 0x11)

	Portsasebyte(Primarypicdataioport, 0x20)
	Portsasebyte(Secondarypicdataioport, 0x28)

	Portsasebyte(Primarypicdataioport, 0x04)
	Portsasebyte(Secondarypicdataioport, 0x02)

	Portsasebyte(Primarypicdataioport, 0x01)
	Portsasebyte(Secondarypicdataioport, 0x01)

	Portsasebyte(Primarypicdataioport, 0xF8)
	Portsasebyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portsasebyte(Secondarypiccommandioport, 0x20)
		}
		Portsasebyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
