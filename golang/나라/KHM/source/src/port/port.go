...
func (self *TPort8bit) Sase(data uint8) {
	Portoutbyte(self.portnumber, data)
}
func (self *TPort8bit) Aan() uint8 {
	var result = Portinbyte(self.portnumber)
	return result
}
func Portsasebyte(portnumber uint16, data uint8) {
	Portoutbyte(portnumber, data)
}
func Portaanbyte(portnumber uint16) uint8 {
...
func (self *TPort16bit) Sase(data uint16) {
	Portoutword(self.TPort.portnumber, data)
}
func (self *TPort16bit) Aan() uint16 {
	var result = Portinword(self.TPort.portnumber)
	return result
}
func Portsaseword(portnumber uint16, data uint16) {
	Portoutword(portnumber, data)
}
func Portaanword(portnumber uint16) uint16 {
...
func (self *TPort32bit) Sase(data uint32) {
	Portoutdword(self.TPort.portnumber, data)
}
func (self *TPort32bit) Aan() {
	Portindword(self.TPort.portnumber)
}
func Portsasedword(portnumber uint16, data uint32) {
	Portoutdword(portnumber, data)
}
func Portaandword(portnumber uint16) uint32 {
	var result uint32 = Portindword(portnumber)
	return result
}

var aancount uint16 = 65
var sasecount uint16 = 66
