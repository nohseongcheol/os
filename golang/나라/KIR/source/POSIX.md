...
freestanding library in `./user_space/posix`.
...
`-I./user_space/posix/headers` and link the archive into an EngOS i386 user
...
`./user_space/posix/TEST_RESULTS.md`. Build all runtime test executables
