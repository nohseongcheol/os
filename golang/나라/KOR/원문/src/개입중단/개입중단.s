...
TEXT ·예외제어저장기0(SB),NOSPLIT,$0
	MOVL CR0, AX
	MOVL AX, ret+0(FP)
	RET

TEXT ·예외제어저장기2(SB),NOSPLIT,$0
	MOVL CR2, AX
	MOVL AX, ret+0(FP)
	RET

TEXT ·예외제어저장기3(SB),NOSPLIT,$0
	MOVL CR3, AX
	MOVL AX, ret+0(FP)
	RET

TEXT ·치명적예외후중지(SB),NOSPLIT,$0
	CLI
fatal_exception_halt:
	BYTE $0xF4 // HLT
	JMP fatal_exception_halt

TEXT ·자료구간선택자설정(SB),NOSPLIT,$0
    MOVL ds_segment+0(FP), AX
    MOVW AX, DS
    RET

TEXT ·추가구간선택자설정(SB),NOSPLIT,$0
...
TEXT ·개입중단요청처리기0x00(SB),NOSPLIT,$0
	interrupt_handler(0x20)	
	

TEXT ·개입중단요청처리기0x01(SB),NOSPLIT,$0
	MOVB $0x4B, 0xB8068; 	 // char 'K'
	interrupt_handler(0x21)
	

TEXT ·개입중단요청처리기0x02(SB),NOSPLIT,$0
	interrupt_handler(0x22)
	

TEXT ·개입중단요청처리기0x03(SB),NOSPLIT,$0
	interrupt_handler(0x23)
	

TEXT ·개입중단요청처리기0x04(SB),NOSPLIT,$0
	interrupt_handler(0x24)
	

TEXT ·개입중단요청처리기0x05(SB),NOSPLIT,$0
	interrupt_handler(0x25)
	

TEXT ·개입중단요청처리기0x06(SB),NOSPLIT,$0
	interrupt_handler(0x26)
	

TEXT ·개입중단요청처리기0x07(SB),NOSPLIT,$0
	interrupt_handler(0x27)
	

TEXT ·개입중단요청처리기0x08(SB),NOSPLIT,$0
	interrupt_handler(0x28)
	

TEXT ·개입중단요청처리기0x09(SB),NOSPLIT,$0
	interrupt_handler(0x29)
	

TEXT ·개입중단요청처리기0x0a(SB),NOSPLIT,$0
	interrupt_handler(0x2A)
	

TEXT ·개입중단요청처리기0x0b(SB),NOSPLIT,$0
	interrupt_handler(0x2B)
	

TEXT ·개입중단요청처리기0x0c(SB),NOSPLIT,$0
	interrupt_handler(0x2C)
	

TEXT ·개입중단요청처리기0x0d(SB),NOSPLIT,$0
	interrupt_handler(0x2D)
	

TEXT ·개입중단요청처리기0x0e(SB),NOSPLIT,$0
	// Hardware IRQ14 does not push a CPU exception error code.
	interrupt_handler(0x2E)

TEXT ·개입중단요청처리기0x0f(SB),NOSPLIT,$0
	interrupt_handler(0x0F)

TEXT ·개입중단요청처리기0x80(SB),NOSPLIT,$0
	interrupt_handler(0x80)

TEXT ·개입중단요청처리기0x81(SB),NOSPLIT,$0
	interrupt_handler(0x81)

TEXT ·개입중단요청처리기0x82(SB),NOSPLIT,$0
	interrupt_handler(0x82)


TEXT ·F개입중단서술자표적재(SB),NOSPLIT,$0
...
TEXT ·F개입중단허용(SB),NOSPLIT,$0
	STI
	RET

TEXT ·F개입중단금지(SB),NOSPLIT,$0
	CLI
	RET

TEXT ·개입중단예외처리기0x00(SB),NOSPLIT,$0
	interrupt_exception(0x00)	

TEXT ·개입중단예외처리기0x01(SB),NOSPLIT,$0
	interrupt_exception(0x01)	

TEXT ·개입중단예외처리기0x02(SB),NOSPLIT,$0
	interrupt_exception(0x02)	

TEXT ·개입중단예외처리기0x03(SB),NOSPLIT,$0
	interrupt_exception(0x03)	

TEXT ·개입중단예외처리기0x04(SB),NOSPLIT,$0
	interrupt_exception(0x04)	

TEXT ·개입중단예외처리기0x05(SB),NOSPLIT,$0
	interrupt_exception(0x05)	

TEXT ·개입중단예외처리기0x06(SB),NOSPLIT,$0
	interrupt_exception(0x06)	

TEXT ·개입중단예외처리기0x07(SB),NOSPLIT,$0
	interrupt_exception(0x07)	

TEXT ·개입중단예외처리기0x08(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x08)	

TEXT ·개입중단예외처리기0x09(SB),NOSPLIT,$0
	interrupt_exception(0x09)	

TEXT ·개입중단예외처리기0x0a(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0A)	

TEXT ·개입중단예외처리기0x0b(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0B)	

TEXT ·개입중단예외처리기0x0c(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0C)	

TEXT ·개입중단예외처리기0x0d(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0D)	

TEXT ·개입중단예외처리기0x0e(SB),NOSPLIT,$0
...
TEXT ·개입중단예외처리기0x0f(SB),NOSPLIT,$0
	interrupt_exception(0x0F)	

TEXT ·개입중단예외처리기0x10(SB),NOSPLIT,$0
	interrupt_exception(0x10)	

TEXT ·개입중단예외처리기0x11(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x11)	

TEXT ·개입중단예외처리기0x12(SB),NOSPLIT,$0
	interrupt_exception(0x12)	

TEXT ·개입중단예외처리기0x13(SB),NOSPLIT,$0
	interrupt_exception(0x13)	

TEXT ·개입중단무시(SB),NOSPLIT,$0
	MOVB $0x4D, 0xB8048 // char 'M'
	IRETL;

TEXT ·개입중단종료대기(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
