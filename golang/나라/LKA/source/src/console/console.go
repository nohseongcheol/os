...
func Serialinit()
func Seriallivimabyte(data uint8)
...
func (self *TConsole) MPrint(argumentඅගය ...interface{}) {
	var x uint16 = 1000
	var y uint16 = 1000
	var අගය_2 interface{}

	for i, p := range argumentඅගය {
		switch i {
		case 0:
			param, _ := p.(interface{})
			අගය_2 = param
