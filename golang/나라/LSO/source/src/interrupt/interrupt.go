...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portngolabyte(Primarypiccommandioport, 0x11)
	Portngolabyte(Secondarypiccommandioport, 0x11)

	Portngolabyte(Primarypicdataioport, 0x20)
	Portngolabyte(Secondarypicdataioport, 0x28)

	Portngolabyte(Primarypicdataioport, 0x04)
	Portngolabyte(Secondarypicdataioport, 0x02)

	Portngolabyte(Primarypicdataioport, 0x01)
	Portngolabyte(Secondarypicdataioport, 0x01)

	Portngolabyte(Primarypicdataioport, 0xF8)
	Portngolabyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portngolabyte(Secondarypiccommandioport, 0x20)
		}
		Portngolabyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
