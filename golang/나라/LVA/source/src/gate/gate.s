...
// used).
TEXT ·HandlePārtraukums(SB),NOSPLIT,$0-10
	...
	LEAQ ·pārtraukumsgateieraksts(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
#define INT_ENTRY_WITH_CODE(num) \
	...
	MOVQ R15, 8(SP);                       \
	LEAQ ·dispatchPārtraukums(SB), R15;      \
	XCHGQ R15, 0(SP);                      \
	BYTE $0xc3;                            \
...
//--------------------------- -----------------------------------------
TEXT ·dispatchPārtraukums(SB),NOSPLIT,$0
...
TEXT ·pārtraukumsgateieraksts(SB),NOSPLIT,$0
