...
freestanding library in `./使用者空間/posix`.
...
`-I./使用者空間/posix/標頭檔` and link the archive into an EngOS i386 user
...
`./使用者空間/posix/TEST_RESULTS.md`. Build all runtime test executables
