...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	var Mac0 uint64 = uint64(Portkiyunword(Macaddress0port) % 256)
	var Mac1 uint64 = uint64(Portkiyunword(Macaddress0port) / 256)
	var Mac2 uint64 = uint64(Portkiyunword(Macaddress2port) % 256)
	var Mac3 uint64 = uint64(Portkiyunword(Macaddress2port) / 256)
	var Mac4 uint64 = uint64(Portkiyunword(Macaddress4port) % 256)
	var Mac5 uint64 = uint64(Portkiyunword(Macaddress4port) / 256)
	...
	Portliyunword(registeraddressport, 20)
	Portliyunword(buscontrolregisterdataport, 0x102)

	Portliyunword(registeraddressport, 0)
	Portliyunword(registerdataport, 0x04)
	...
	Portliyunword(registeraddressport, 1)
	Portliyunword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Portliyunword(registeraddressport, 2)
	Portliyunword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Portliyunword(registeraddressport, 0)
	Portliyunword(registerdataport, 0x41)

	Portliyunword(registeraddressport, 4)
	temporary := Portkiyunword(registerdataport)
	Portliyunword(registeraddressport, 4)
	Portliyunword(registerdataport, temporary|0xC00)

	Portliyunword(registeraddressport, 0)
	Portliyunword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portkiyunword(resetport)
	Portliyunword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Portliyunword(registeraddressport, 0)
	temporary := uint32(Portkiyunword(registerdataport))
	...
	Portliyunword(registeraddressport, 0)
	Portliyunword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Portliyunword(registeraddressport, 0)
	Portliyunword(registerdataport, 0x48)
