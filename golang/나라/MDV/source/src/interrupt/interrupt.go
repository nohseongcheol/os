...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portliyunbyte(Primarypiccommandioport, 0x11)
	Portliyunbyte(Secondarypiccommandioport, 0x11)

	Portliyunbyte(Primarypicdataioport, 0x20)
	Portliyunbyte(Secondarypicdataioport, 0x28)

	Portliyunbyte(Primarypicdataioport, 0x04)
	Portliyunbyte(Secondarypicdataioport, 0x02)

	Portliyunbyte(Primarypicdataioport, 0x01)
	Portliyunbyte(Secondarypicdataioport, 0x01)

	Portliyunbyte(Primarypicdataioport, 0xF8)
	Portliyunbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portliyunbyte(Secondarypiccommandioport, 0x20)
		}
		Portliyunbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
