...
const (
	...
	BoundОпсегexceeded	= Interruptnumber(5)

	Невалидноopcode	= Interruptnumber(6)

	УредnotДостапно	= Interruptnumber(7)

	Doublefault	= Interruptnumber(8)

	Невалидноtss	= Interruptnumber(10)
	...
	Страницаfaultexception	= Interruptnumber(14)
