...
TEXT ·поставиds(SB),NOSPLIT,$0
    MOVL ds_segment+0(FP), AX
    MOVW AX, DS
    RET

TEXT ·поставиgs(SB),NOSPLIT,$0
...
TEXT ·Interruptактивно(SB),NOSPLIT,$0
	STI
	RET
...
TEXT ·interruptИзлезloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD

TEXT ·поставиcr3(SB),NOSPLIT,$0
        MOVL cr3+0(FP), AX
        MOVL AX, CR3
        RET
