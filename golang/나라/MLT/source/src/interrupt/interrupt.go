...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portiktebbyte(Primarypiccommandioport, 0x11)
	Portiktebbyte(Secondarypiccommandioport, 0x11)

	Portiktebbyte(Primarypicdataioport, 0x20)
	Portiktebbyte(Secondarypicdataioport, 0x28)

	Portiktebbyte(Primarypicdataioport, 0x04)
	Portiktebbyte(Secondarypicdataioport, 0x02)

	Portiktebbyte(Primarypicdataioport, 0x01)
	Portiktebbyte(Secondarypicdataioport, 0x01)

	Portiktebbyte(Primarypicdataioport, 0xF8)
	Portiktebbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portiktebbyte(Secondarypiccommandioport, 0x20)
		}
		Portiktebbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
