...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portyaybyte(Primarypiccommandioport, 0x11)
	Portyaybyte(Secondarypiccommandioport, 0x11)

	Portyaybyte(Primarypicdataioport, 0x20)
	Portyaybyte(Secondarypicdataioport, 0x28)

	Portyaybyte(Primarypicdataioport, 0x04)
	Portyaybyte(Secondarypicdataioport, 0x02)

	Portyaybyte(Primarypicdataioport, 0x01)
	Portyaybyte(Secondarypicdataioport, 0x01)

	Portyaybyte(Primarypicdataioport, 0xF8)
	Portyaybyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portyaybyte(Secondarypiccommandioport, 0x20)
		}
		Portyaybyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
