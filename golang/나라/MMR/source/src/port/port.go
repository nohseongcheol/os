...
func (self *TPort8bit) Yay(data uint8) {
	Portoutbyte(self.portnumber, data)
}
func (self *TPort8bit) Hpatt() uint8 {
	var result = Portinbyte(self.portnumber)
	return result
}
func Portyaybyte(portnumber uint16, data uint8) {
	Portoutbyte(portnumber, data)
}
func Porthpattbyte(portnumber uint16) uint8 {
...
func (self *TPort16bit) Yay(data uint16) {
	Portoutword(self.TPort.portnumber, data)
}
func (self *TPort16bit) Hpatt() uint16 {
	var result = Portinword(self.TPort.portnumber)
	return result
}
func Portyayword(portnumber uint16, data uint16) {
	Portoutword(portnumber, data)
}
func Porthpattword(portnumber uint16) uint16 {
...
func (self *TPort32bit) Yay(data uint32) {
	Portoutdword(self.TPort.portnumber, data)
}
func (self *TPort32bit) Hpatt() {
	Portindword(self.TPort.portnumber)
}
func Portyaydword(portnumber uint16, data uint32) {
	Portoutdword(portnumber, data)
}
func Porthpattdword(portnumber uint16) uint32 {
	var result uint32 = Portindword(portnumber)
	return result
}

var hpattcount uint16 = 65
var yaycount uint16 = 66
