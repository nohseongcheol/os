# Mongolia (MNG) source language

- country: Mongolia (MN)
- selected language: mn_Cyrl
- CLDR population: 93%
- official status: official
- native language name: Монгол
- target-language vocabulary: 108
- unresolved source-glossary vocabulary: 763
