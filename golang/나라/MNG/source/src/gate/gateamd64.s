...
GLOBL ·дугаарtDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·дугаарt<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
TEXT ·суулгахidt(SB),NOSPLIT,$0
	LEAQ ·дугаарtDescriptor<>(SB), AX
