...
// used).
TEXT ·KendaliSampuk(SB),NOSPLIT,$0-10
	...
	LEAQ ·sampukgateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchSampuk(SB),NOSPLIT,$0
...
TEXT ·sampukgateentry(SB),NOSPLIT,$0
