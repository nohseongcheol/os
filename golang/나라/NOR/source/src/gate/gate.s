...
// used).
TEXT ·HåndtakAvbrudd(SB),NOSPLIT,$0-10
	...
	LEAQ ·avbruddgateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchAvbrudd(SB),NOSPLIT,$0
...
TEXT ·avbruddgateentry(SB),NOSPLIT,$0
