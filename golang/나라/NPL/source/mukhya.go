...
func KKernelEntry(Pagedirectoryentry uintptr, stacktop uintptr, stackbottom uintptr) {
	...
	processhelper.Spawn(आगतeventtask, threadhelper, sche, uint32(Pagedirectoryentry), true)
	...
	Padhnufile(linkerfile, linkerdata)
	...
	Padhnufile(user1file, user1data)
	...
	*code1pointer = uintptr(linkerentry)
	...
	Padhnufile(user2file, user2data)
	...
	*code2pointer = uintptr(linkerentry)
	...
	Padhnufile(user3file, user3data)
