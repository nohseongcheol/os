...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portlekhnubyte(Primarypiccommandioport, 0x11)
	Portlekhnubyte(Secondarypiccommandioport, 0x11)

	Portlekhnubyte(Primarypicdataioport, 0x20)
	Portlekhnubyte(Secondarypicdataioport, 0x28)

	Portlekhnubyte(Primarypicdataioport, 0x04)
	Portlekhnubyte(Secondarypicdataioport, 0x02)

	Portlekhnubyte(Primarypicdataioport, 0x01)
	Portlekhnubyte(Secondarypicdataioport, 0x01)

	Portlekhnubyte(Primarypicdataioport, 0xF8)
	Portlekhnubyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portlekhnubyte(Secondarypiccommandioport, 0x20)
		}
		Portlekhnubyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
