...
func (self *TPort8bit) Lekhnu(data uint8) {
	Portoutbyte(self.portnumber, data)
}
func (self *TPort8bit) Padhnu() uint8 {
	var result = Portinbyte(self.portnumber)
	return result
}
func Portlekhnubyte(portnumber uint16, data uint8) {
	Portoutbyte(portnumber, data)
}
func Portpadhnubyte(portnumber uint16) uint8 {
...
func (self *TPort16bit) Lekhnu(data uint16) {
	Portoutword(self.TPort.portnumber, data)
}
func (self *TPort16bit) Padhnu() uint16 {
	var result = Portinword(self.TPort.portnumber)
	return result
}
func Portlekhnuword(portnumber uint16, data uint16) {
	Portoutword(portnumber, data)
}
func Portpadhnuword(portnumber uint16) uint16 {
...
func (self *TPort32bit) Lekhnu(data uint32) {
	Portoutdword(self.TPort.portnumber, data)
}
func (self *TPort32bit) Padhnu() {
	Portindword(self.TPort.portnumber)
}
func Portlekhnudword(portnumber uint16, data uint32) {
	Portoutdword(portnumber, data)
}
func Portpadhnudword(portnumber uint16) uint32 {
	var result uint32 = Portindword(portnumber)
	return result
}

var padhnucount uint16 = 65
var lekhnucount uint16 = 66
