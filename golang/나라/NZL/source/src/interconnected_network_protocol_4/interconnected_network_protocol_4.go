package interconnected_network_protocol_4
...
type IInternetprotocolhandler interface {
	Init(backend TInterconnected_network_protocol_provider, pihandler IInternetprotocolhandler, pprotocol uint8)
	...
	Providerget() *TInterconnected_network_protocol_provider
}
...
func (self *TInternetprotocolhandler) Init(backend TInterconnected_network_protocol_provider, pihandler IInternetprotocolhandler, pprotocol uint8) {
	protocol = pprotocol
...
func (self *TInternetprotocolhandler) Send(destinationipaddressnetworkbyteorder uint32, pprotocol uint8, datapointer uintptr, size uint32) {
	...
	interconnected_network_protocol_provider.Send(destinationipaddressnetworkbyteorder, pprotocol, datapointer, size)
}
func (self *TInternetprotocolhandler) Providerget() *TInterconnected_network_protocol_provider {
	return &interconnected_network_protocol_provider
}
...
var interconnected_network_protocol_provider TInterconnected_network_protocol_provider
...
func (self *Ipethernetframehandler) Ethernetframereceivewhen(datapointer uintptr, size int) bool {
	...
	return interconnected_network_protocol_provider.Ethernetframereceivewhen(datapointer, uint32(size))
...
type TInterconnected_network_protocol_provider struct {
...
func (self *TInterconnected_network_protocol_provider) Init(pefprovider TShared_medium_network_frame_provider, pefhandler IEthernetframehandler, arp Arpprovider, gatewayip uint32, subnetmask uint32) {
	...
	interconnected_network_protocol_provider = *self
}
func (self *TInterconnected_network_protocol_provider) Ethernetframereceivewhen(ethernetframepayload uintptr, size uint32) bool {
...
func (self *TInterconnected_network_protocol_provider) Send(destinationipaddressnetworkbyteorder uint32, protocol uint8, datapointer uintptr, size uint32) {
...
func (self *TInterconnected_network_protocol_provider) Checksum(pdata *[4096]uint16, lengthinbytes uint32) uint16 {
...
func (self *TInterconnected_network_protocol_provider) Getipaddress() uint64 {
