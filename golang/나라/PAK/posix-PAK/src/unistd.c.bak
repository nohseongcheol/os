...
{
    return (ssize_t)__syscall_result(SC3(SYS_پڑھیں, فائل_کا_وصف_کنندہ, منتقلی_کا_عارضی_ذخیرہ, count));
}

ssize_t لکھیں(int فائل_کا_وصف_کنندہ, const void *منتقلی_کا_عارضی_ذخیرہ, size_t count)
{
    return (ssize_t)__syscall_result(SC3(SYS_لکھیں, فائل_کا_وصف_کنندہ, منتقلی_کا_عارضی_ذخیرہ, count));
}

int بندکریں(int فائل_کا_وصف_کنندہ)
{
    return (int)__syscall_result(SC1(SYS_بندکریں, فائل_کا_وصف_کنندہ));
}
