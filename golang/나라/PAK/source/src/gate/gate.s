...
GLOBL ·آئیڈیtDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·آئیڈیt<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
TEXT ·نصبکریںidt(SB),NOSPLIT,$0
	LEAQ ·آئیڈیtDescriptor<>(SB), AX
...
// used).
TEXT ·Handleمداخلت(SB),NOSPLIT,$0-10
	...
	LEAQ ·مداخلتgateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchمداخلت(SB),NOSPLIT,$0
...
TEXT ·مداخلتgateentry(SB),NOSPLIT,$0
