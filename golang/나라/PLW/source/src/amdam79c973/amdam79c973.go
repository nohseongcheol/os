...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	var Mac0 uint64 = uint64(Portparhnaword(Macaddress0port) % 256)
	var Mac1 uint64 = uint64(Portparhnaword(Macaddress0port) / 256)
	var Mac2 uint64 = uint64(Portparhnaword(Macaddress2port) % 256)
	var Mac3 uint64 = uint64(Portparhnaword(Macaddress2port) / 256)
	var Mac4 uint64 = uint64(Portparhnaword(Macaddress4port) % 256)
	var Mac5 uint64 = uint64(Portparhnaword(Macaddress4port) / 256)
...
func (self *Tamdam79c973) Activate() {
	...
	temporary := Portparhnaword(registerdataport)
	Portlikhnaword(registeraddressport, 4)
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Portlikhnaword(registeraddressport, 0)
	temporary := uint32(Portparhnaword(registerdataport))
