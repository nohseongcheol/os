...
var attributecontrollerparhnaport uint16 = 0x3c1
...
func (self *TVideographicsarray) Likhnaregister(register []byte) {
	...
	Portlikhnabyte(crtcdataport, (Portparhnabyte(crtcdataport) | 0x80))
	Portlikhnabyte(crtcindexport, 0x11)
	Portlikhnabyte(crtcdataport, (Portparhnabyte(crtcdataport) & ^uint8(0x80)))
	...
	for i = 0; i < 21; i++ {
		Portparhnabyte(attributecontrollerresetport)
...
func (self *TVideographicsarray) Getframebuffersegment() uintptr {
	...
	var segmentnumber uint8 = ((Portparhnabyte(graphicscontrollerdataport) >> 2) & 0x03)
