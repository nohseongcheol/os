...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portraitimbyte(Primarypiccommandioport, 0x11)
	Portraitimbyte(Secondarypiccommandioport, 0x11)

	Portraitimbyte(Primarypicdataioport, 0x20)
	Portraitimbyte(Secondarypicdataioport, 0x28)

	Portraitimbyte(Primarypicdataioport, 0x04)
	Portraitimbyte(Secondarypicdataioport, 0x02)

	Portraitimbyte(Primarypicdataioport, 0x01)
	Portraitimbyte(Secondarypicdataioport, 0x01)

	Portraitimbyte(Primarypicdataioport, 0xF8)
	Portraitimbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portraitimbyte(Secondarypiccommandioport, 0x20)
		}
		Portraitimbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
