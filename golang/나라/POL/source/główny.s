...
TEXT ·getgs(SB),NOSPLIT,$0
	MOVW GS, ret+4(FP)
	RET
TEXT ·Wstrzymajloop(SB), NOSPLIT, $0
	PAUSE_LOOP:
	MOVL $0x1, AX
	CMPL AX, $0x1
	JE PAUSE_LOOP
...
TEXT ·Wczytajponowniecr3(SB),NOSPLIT,$0
	MOVL CR3, AX
	MOVL AX, CR3
	MOVL AX, ret+0(FP)
	RET
