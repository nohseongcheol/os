...
TEXT ·WyłączCałkowity(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpTrybużytkownikairet(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpTrybużytkownikairet1(SB),NOSPLIT,$0
	RET

TEXT ·threadZakończloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·przywróćfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
