...
freestanding library in `./사용자영역/posix`.
...
`-I./사용자영역/posix/머리파일` and link the archive into an EngOS i386 user
...
`./사용자영역/posix/TEST_RESULTS.md`. Build all runtime test executables
