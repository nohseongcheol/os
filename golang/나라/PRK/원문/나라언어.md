# Korea, Democratic People's Republic of (PRK) source language

- country: Korea, Democratic People's Republic of (KP)
- selected language: ko
- CLDR population: 88%
- official status: official
- native language name: 한국어
- target-language vocabulary: 401
- unresolved source-glossary vocabulary: 484
