...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	var Mac0 uint64 = uint64(Portmoñeẽword(Macaddress0port) % 256)
	var Mac1 uint64 = uint64(Portmoñeẽword(Macaddress0port) / 256)
	var Mac2 uint64 = uint64(Portmoñeẽword(Macaddress2port) % 256)
	var Mac3 uint64 = uint64(Portmoñeẽword(Macaddress2port) / 256)
	var Mac4 uint64 = uint64(Portmoñeẽword(Macaddress4port) % 256)
	var Mac5 uint64 = uint64(Portmoñeẽword(Macaddress4port) / 256)
	...
	Porthaiword(registeraddressport, 20)
	Porthaiword(buscontrolregisterdataport, 0x102)

	Porthaiword(registeraddressport, 0)
	Porthaiword(registerdataport, 0x04)
	...
	Porthaiword(registeraddressport, 1)
	Porthaiword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Porthaiword(registeraddressport, 2)
	Porthaiword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Porthaiword(registeraddressport, 0)
	Porthaiword(registerdataport, 0x41)

	Porthaiword(registeraddressport, 4)
	temporary := Portmoñeẽword(registerdataport)
	Porthaiword(registeraddressport, 4)
	Porthaiword(registerdataport, temporary|0xC00)

	Porthaiword(registeraddressport, 0)
	Porthaiword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portmoñeẽword(resetport)
	Porthaiword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Porthaiword(registeraddressport, 0)
	temporary := uint32(Portmoñeẽword(registerdataport))
	...
	Porthaiword(registeraddressport, 0)
	Porthaiword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Porthaiword(registeraddressport, 0)
	Porthaiword(registerdataport, 0x48)
