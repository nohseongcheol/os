...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Porthaibyte(Primarypiccommandioport, 0x11)
	Porthaibyte(Secondarypiccommandioport, 0x11)

	Porthaibyte(Primarypicdataioport, 0x20)
	Porthaibyte(Secondarypicdataioport, 0x28)

	Porthaibyte(Primarypicdataioport, 0x04)
	Porthaibyte(Secondarypicdataioport, 0x02)

	Porthaibyte(Primarypicdataioport, 0x01)
	Porthaibyte(Secondarypicdataioport, 0x01)

	Porthaibyte(Primarypicdataioport, 0xF8)
	Porthaibyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Porthaibyte(Secondarypiccommandioport, 0x20)
		}
		Porthaibyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
