...
TEXT ·Désactiverint(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpModeutilisateuriret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpModeutilisateuriret1(SB),NOSPLIT,$0
	RET

TEXT ·filExécutionQuitterBoucles(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·restaurerfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
