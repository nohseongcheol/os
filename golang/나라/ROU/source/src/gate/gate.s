...
TEXT ·instaleazăidt(SB),NOSPLIT,$0
...
// used).
TEXT ·MânerIntrerupere(SB),NOSPLIT,$0-10
	...
	LEAQ ·intreruperegateînregistrare(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
#define INT_ENTRY_WITH_CODE(num) \
	...
	MOVQ R15, 8(SP);                       \
	LEAQ ·dispatchIntrerupere(SB), R15;      \
	XCHGQ R15, 0(SP);                      \
	BYTE $0xc3;                            \
...
//--------------------------- -----------------------------------------
TEXT ·dispatchIntrerupere(SB),NOSPLIT,$0
...
TEXT ·intreruperegateînregistrare(SB),NOSPLIT,$0
