...
const (
	...
	BoundIgiceexceeded	= Interruptnumber(5)

	Bitemeweopcode	= Interruptnumber(6)

	Ububikonotavailable	= Interruptnumber(7)

	Doublefault	= Interruptnumber(8)

	Bitemewetss	= Interruptnumber(10)
	...
	Ipajifaultexception	= Interruptnumber(14)
