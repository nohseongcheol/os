...
func TestGucapa(position uint8, data uint8)
func setds(dssegment uint32)
func setgs(gssegment uint32)
func interruptGusohokaloop()
...
type TInterruptdescriptorImbonerahamwepointer struct {
}

var idtdata [256 * 8]uint8
var Gikorainterruptmanager uintptr = 0
...
var PrimarypicIcyowifuzaioUmuyoboro uint16 = 0x20
var PrimarypicdataioUmuyoboro uint16 = 0x21
var SecondarypicIcyowifuzaioUmuyoboro uint16 = 0xA0
var SecondarypicdataioUmuyoboro uint16 = 0xA1

func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptorImbonerahamwe *TShareddescriptorImbonerahamwe, taskmanager *TTaskmanager) {
	...
	for i := 0; i < 256; i++ {
		...
		self.InterruptdescriptorImbonerahamweentryset(i, codesegment, address, 0, Idtinterruptgate)
	}

	address = uint32(ValueOf(interruptexceptionhandler0x00).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x00, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x01).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x01, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x02).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x02, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x03).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x03, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x04).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x04, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x05).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x05, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x06).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x06, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x07).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x07, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x08).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x08, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x09).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x09, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0a).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x0A, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0b).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x0B, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x0c).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x0C, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x0d).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x0D, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0e).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x0E, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0f).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x0F, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x10).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x10, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x11).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x11, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x12).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x12, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x13).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x13, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x00).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x20, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x01).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x21, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x02).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x22, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x03).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x23, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x04).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x24, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x05).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x25, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x06).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x26, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x07).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x27, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x08).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x28, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x09).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x29, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0a).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x2A, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0b).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x2B, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0c).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x2C, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0d).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x2D, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0e).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x2E, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0f).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x2F, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x80).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x80, codesegment, address, 3, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x81).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x81, codesegment, address, 3, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x82).Pointer())
	self.InterruptdescriptorImbonerahamweentryset(0x82, codesegment, address, 3, Idtinterruptgate)

	Umuyoborokwandikabyte(PrimarypicIcyowifuzaioUmuyoboro, 0x11)
	Umuyoborokwandikabyte(SecondarypicIcyowifuzaioUmuyoboro, 0x11)

	Umuyoborokwandikabyte(PrimarypicdataioUmuyoboro, 0x20)
	Umuyoborokwandikabyte(SecondarypicdataioUmuyoboro, 0x28)

	Umuyoborokwandikabyte(PrimarypicdataioUmuyoboro, 0x04)
	Umuyoborokwandikabyte(SecondarypicdataioUmuyoboro, 0x02)

	Umuyoborokwandikabyte(PrimarypicdataioUmuyoboro, 0x01)
	Umuyoborokwandikabyte(SecondarypicdataioUmuyoboro, 0x01)

	Umuyoborokwandikabyte(PrimarypicdataioUmuyoboro, 0xF8)
	Umuyoborokwandikabyte(SecondarypicdataioUmuyoboro, 0xEF)

	idtpointer := [6]uint8{0, 0, 0, 0, 0, 0}
	ingano := (*uint16)(Pointer(&idtpointer[0]))
	(*ingano) = (uint16)(Sizeof(idtdata) - 1)
...
func (self *TInterruptmanager) InterruptdescriptorImbonerahamweentryset(interrupt int,
	codesegment uint16,
	handler uint32,
	Descriptorprivilegelevel uint8,
	DescriptorUbwoko uint8) {
	...
	(*access) = (Idtdescriptorpresent | DescriptorUbwoko | ((Descriptorprivilegelevel & 3) << 5))
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if interruptdebug {
		console_2.MGucapaxy("[esp:", 1, 20)
		console_2.MUnsignedinteger32Gucapa(uint32(interrupt))
		console_2.MGucapa(":")
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Umuyoborokwandikabyte(SecondarypicIcyowifuzaioUmuyoboro, 0x20)
		}
		Umuyoborokwandikabyte(PrimarypicIcyowifuzaioUmuyoboro, 0x20)
	}
	return esp
}
...
func Handleinterrupt(esp uint32, interrupt uint32) uint32 {
	...
	if interruptdebug && interrupt != 0x80 && interrupt != 0x20 {
		console_2.MGucapaxy("[esp:", 1, 21)
		console_2.MUnsignedinteger32Gucapa(uint32(interrupt))
		console_2.MGucapa(":")
		console_2.MUnsignedinteger32Gucapa(esp)
	}

	if Gikorainterruptmanager != 0 {
		p := (*TInterruptmanager)(Pointer(Gikorainterruptmanager))
...
func handleunhandledsyscall(esp uint32) uint32 {
	...
	if cpu.Eax == 1 || cpu.Eax == 252 {
		cpu.Eip = uint32(ValueOf(interruptGusohokaloop).Pointer())
...
func exceptionhasIkosacode(interrupt uint32) bool {
	switch interrupt {
...
func exceptionIzina(interrupt uint32) string {
	switch interrupt {
	case 0x00:
...
func exceptionIkadiriAgaciro(ikadiri uint32, offset uint32) uint32 {
	return *(*uint32)(Pointer(uintptr(ikadiri + offset)))
}
...
func gucapaIpajifaultinfo(err uint32) {
...
func gucapaexceptionselectorinfo(err uint32) {
...
func Handleexception(esp uint32, interrupt uint32) uint32 {
	...
	if exceptionhasIkosacode(interrupt) {
		err = exceptionIkadiriAgaciro(esp, 0)
		eipoffset = 4
	}
	eip := exceptionIkadiriAgaciro(esp, eipoffset)
	cs := exceptionIkadiriAgaciro(esp, eipoffset+4)
	eflags := exceptionIkadiriAgaciro(esp, eipoffset+8)
	...
	if interrupt == 0x0E {
		...
		gucapaIpajifaultinfo(err)
	}

	if (cs & 0x03) != 0 {
		MEmergencylogstring(" useresp=")
		MEmergencylogunsignedinteger32(exceptionIkadiriAgaciro(esp, eipoffset+12))
		MEmergencylogstring(" ss=")
		MEmergencylogunsignedinteger32(exceptionIkadiriAgaciro(esp, eipoffset+16))
	}

	if exceptionhasIkosacode(interrupt) {
		gucapaexceptionselectorinfo(err)
	}
	MEmergencylogstring("\n=== ENGOS HALTED AFTER EXCEPTION ===\n")
	except++
...
func HandlefatalinterruptIkadiri(savedesp uint32, interrupt uint32) uint32 {
	Handleexception(savedesp+52, interrupt)
	haltafterfatalexception()
	return savedesp
}

func InterruptGikora()
func (self *TInterruptmanager) Gikora() {
	if Gikorainterruptmanager != 0 {
		self.Deactive()
	}
	address := uintptr(Pointer(self))
	Gikorainterruptmanager = address
	InterruptGikora()
}
func Interruptdeactive()
func (self *TInterruptmanager) Deactive() {
	Gikorainterruptmanager = 0
	Interruptdeactive()
}
...
func interrupthandler_2(interrupt uint8, esp uint32) uint32 {
	...
	console_2 := TConsole{}
	console_2.MGucapa(buffer)
	console_2.MHexadecimalGucapa(0x40)
	return esp
}
func gucapaesp(esp uint32) {
	console_2 := TConsole{}
	console_2.MUnsignedinteger32Gucapaxy(esp, 20, 21)
}
func gettls() uint32
func Gucapatls() {
