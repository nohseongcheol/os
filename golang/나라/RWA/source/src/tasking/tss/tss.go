...
var tssUmubarendanga uint32 = 0
var flushUmubarendanga uint32 = 0

func flushtss(uint32)
func (self *Tssentry) Install(gdt *TShareddescriptorImbonerahamwe, idx int, kernelss uint32, kernelesp uint32) {

	console_2.MGucapaxy(([]byte)("tss:"), 20, 13)
	base := uint32(uintptr(Pointer(self)))
	console_2.MUnsignedinteger32Gucapa(base)
	console_2.MGucapa(":")
