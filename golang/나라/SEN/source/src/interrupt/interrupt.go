...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portbindbyte(Primarypiccommandioport, 0x11)
	Portbindbyte(Secondarypiccommandioport, 0x11)

	Portbindbyte(Primarypicdataioport, 0x20)
	Portbindbyte(Secondarypicdataioport, 0x28)

	Portbindbyte(Primarypicdataioport, 0x04)
	Portbindbyte(Secondarypicdataioport, 0x02)

	Portbindbyte(Primarypicdataioport, 0x01)
	Portbindbyte(Secondarypicdataioport, 0x01)

	Portbindbyte(Primarypicdataioport, 0xF8)
	Portbindbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portbindbyte(Secondarypiccommandioport, 0x20)
		}
		Portbindbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
