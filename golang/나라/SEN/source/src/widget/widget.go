...
func (self *TWidget) Draw(vga *TVideoGraafikarray) {
...
var mousevga TVideoGraafikarray
var previousx int16 = 0
var previousy int16 = 0
var xposition int16 = 0
var yposition int16 = 0

func (self *TWidgetmouseeventhandler) Init(widget TWidget, vga TVideoGraafikarray) {
	mousewidget = widget
	mousevga = vga
}
