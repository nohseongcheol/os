# Svalbard and Jan Mayen (SJM) source language

- country: Svalbard and Jan Mayen (SJ)
- selected language: nb
- CLDR population: 80%
- official status: official
- native language name: Norwegian Bokmål
- target-language vocabulary: 226
- unresolved source-glossary vocabulary: 645
