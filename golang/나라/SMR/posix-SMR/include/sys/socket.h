...
int bind(int descrittore_del_file, const struct sockaddr *address, socklen_t address_len);
int connect(int descrittore_del_file, const struct sockaddr *address, socklen_t address_len);
int listen(int descrittore_del_file, int backlog);
int accept(int descrittore_del_file, struct sockaddr *address, socklen_t *address_len);
int getsockname(int descrittore_del_file, struct sockaddr *address, socklen_t *address_len);
int getpeername(int descrittore_del_file, struct sockaddr *address, socklen_t *address_len);
...
ssize_t sendto(int descrittore_del_file, const void *message, size_t lunghezza, int flags,
