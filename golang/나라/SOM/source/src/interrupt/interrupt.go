...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portqorbyte(Primarypiccommandioport, 0x11)
	Portqorbyte(Secondarypiccommandioport, 0x11)

	Portqorbyte(Primarypicdataioport, 0x20)
	Portqorbyte(Secondarypicdataioport, 0x28)

	Portqorbyte(Primarypicdataioport, 0x04)
	Portqorbyte(Secondarypicdataioport, 0x02)

	Portqorbyte(Primarypicdataioport, 0x01)
	Portqorbyte(Secondarypicdataioport, 0x01)

	Portqorbyte(Primarypicdataioport, 0xF8)
	Portqorbyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portqorbyte(Secondarypiccommandioport, 0x20)
		}
		Portqorbyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
