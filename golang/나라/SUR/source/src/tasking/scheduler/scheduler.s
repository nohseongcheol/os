...
TEXT ·Uitschakelenint(SB),NOSPLIT,$0
	CLI
	RET
...
TEXT ·jumpGebruikermodeiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpGebruikermodeiret1(SB),NOSPLIT,$0
	RET

TEXT ·threadAfsluitenloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·herstellenfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
