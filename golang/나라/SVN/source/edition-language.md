# Slovenia (SVN) source language

- country: Slovenia (SI)
- selected language: sl
- CLDR population: 87%
- official status: official
- native language name: slovenščina
- target-language vocabulary: 225
- unresolved source-glossary vocabulary: 646
