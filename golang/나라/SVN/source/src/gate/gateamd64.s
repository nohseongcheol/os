...
// used).
TEXT ·RočicaPrekinitev(SB),NOSPLIT,$0-10
	...
	LEAQ ·prekinitevgatevnos(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
#define INT_ENTRY_WITH_CODE(num) \
	...
	MOVQ R15, 8(SP);                       \
	LEAQ ·dispatchPrekinitev(SB), R15;      \
	XCHGQ R15, 0(SP);                      \
	BYTE $0xc3;                            \
...
//--------------------------- -----------------------------------------
TEXT ·dispatchPrekinitev(SB),NOSPLIT,$0
...
TEXT ·prekinitevgatevnos(SB),NOSPLIT,$0
