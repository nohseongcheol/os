...
TEXT ·Uppdateracr3(SB),NOSPLIT,$0
	MOVL CR3, AX
	MOVL AX, CR3
	MOVL AX, ret+0(FP)
	RET
...
TEXT ·Getcr4(SB),NOSPLIT,$0
	...
	MOVL AX, ret+0(FP)
	RET
TEXT ·Aktiverapaging(SB),NOSPLIT,$0
    MOVL CR0, AX
    ORL $0x80000001, AX
    MOVL AX, CR0
    RET
