...
func Tทดสอบprint(position uint8, data uint8)
func กำหนดds(dssegment uint32)
func กำหนดgs(gssegment uint32)
...
func (self *TInterrupthandler) Sกำหนดhandleinterruptfuction(Interruptnumber uint32, address uintptr) {
	handler_2[Interruptnumber] = address
}
func (self *TInterrupthandler) Dทำลาย() {
	...
	if selfuintptr == Interruptmanager.Gethandler(self.Interruptnumber) {
		Interruptmanager.Sกำหนดhandler(0, self.Interruptnumber)
	}

}
func (self *TInterrupthandler) Sกำหนดinterruptmanager(Interruptmanager uintptr) {
}
func (self *TInterrupthandler) Sกำหนดinterruptnumber(Interruptnumber uint8) {
	self.Interruptnumber = Interruptnumber
}
...
type TInterruptdescriptorตารางpointer struct {
}

var idtdata [256 * 8]uint8
var Aทำงานinterruptmanager uintptr = 0
...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptorตาราง *TShareddescriptorตาราง, taskmanager *TTaskmanager) {
	...
	for i := 0; i < 256; i++ {
		...
		self.Interruptdescriptorตารางentryกำหนด(i, codesegment, address, 0, Idtinterruptgate)
	}

	address = uint32(ValueOf(interruptexceptionhandler0x00).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x00, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x01).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x01, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x02).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x02, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x03).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x03, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x04).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x04, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x05).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x05, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x06).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x06, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x07).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x07, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x08).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x08, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x09).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x09, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0a).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x0A, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0b).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x0B, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x0c).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x0C, codesegment, address, 0, Idtinterruptgate)
	address = uint32(ValueOf(interruptexceptionhandler0x0d).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x0D, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0e).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x0E, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x0f).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x0F, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x10).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x10, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x11).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x11, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x12).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x12, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptexceptionhandler0x13).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x13, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x00).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x20, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x01).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x21, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x02).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x22, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x03).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x23, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x04).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x24, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x05).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x25, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x06).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x26, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x07).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x27, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x08).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x28, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x09).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x29, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0a).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x2A, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0b).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x2B, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0c).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x2C, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0d).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x2D, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0e).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x2E, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x0f).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x2F, codesegment, address, 0, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x80).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x80, codesegment, address, 3, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x81).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x81, codesegment, address, 3, Idtinterruptgate)

	address = uint32(ValueOf(interruptrequesthandler0x82).Pointer())
	self.Interruptdescriptorตารางentryกำหนด(0x82, codesegment, address, 3, Idtinterruptgate)
	...
	ขนาด := (*uint16)(Pointer(&idtpointer[0]))
	(*ขนาด) = (uint16)(Sizeof(idtdata) - 1)
...
func (self *TInterruptmanager) Interruptdescriptorตารางentryกำหนด(interrupt int,
	codesegment uint16,
	handler uint32,
	Descriptorprivilegelevel uint8,
	Descriptorประเภท uint8) {
	...
	(*access) = (Idtdescriptorpresent | Descriptorประเภท | ((Descriptorprivilegelevel & 3) << 5))
...
func (self *TInterruptmanager) Sกำหนดhandler(handler uintptr, Interruptnumber uint8) {
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if !handlerrun && interrupt == uint8(self.hardwareinterruptoffset) && self.taskmanager != nil {
		esp = uint32(uintptr(Pointer(self.taskmanager.Schedule((*Tcpuสถานะ)(Pointer(uintptr(esp)))))))
...
func Handleinterrupt(esp uint32, interrupt uint32) uint32 {
	...
	if Aทำงานinterruptmanager != 0 {
		p := (*TInterruptmanager)(Pointer(Aทำงานinterruptmanager))
...
func handleunhandledsyscall(esp uint32) uint32 {
	cpu := (*Tcpuสถานะ)(Pointer(uintptr(esp)))
...
func exceptionเฟรมvalue(เฟรม uint32, offset uint32) uint32 {
	return *(*uint32)(Pointer(uintptr(เฟรม + offset)))
}
...
func Handleexception(esp uint32, interrupt uint32) uint32 {
	...
	if exceptionhaserrorcode(interrupt) {
		err = exceptionเฟรมvalue(esp, 0)
		eipoffset = 4
	}
	eip := exceptionเฟรมvalue(esp, eipoffset)
	cs := exceptionเฟรมvalue(esp, eipoffset+4)
	eflags_2 := exceptionเฟรมvalue(esp, eipoffset+8)
	...
	if (cs & 0x03) != 0 {
		...
		MEmergencylogunsignedinteger32(exceptionเฟรมvalue(esp, eipoffset+12))
		MEmergencylogstring(" ss=")
		MEmergencylogunsignedinteger32(exceptionเฟรมvalue(esp, eipoffset+16))
	}
...
func Handlefatalinterruptเฟรม(savedesp uint32, interrupt uint32) uint32 {
...
func Interruptทำงาน()
func (self *TInterruptmanager) Aทำงาน() {
	if Aทำงานinterruptmanager != 0 {
		self.Deactive()
	}
	address := uintptr(Pointer(self))
	Aทำงานinterruptmanager = address
	Interruptทำงาน()
}
func Interruptdeactive()
func (self *TInterruptmanager) Deactive() {
	Aทำงานinterruptmanager = 0
	Interruptdeactive()
}
...
func Myทดสอบ(interrupt uint8, esp uint32)
