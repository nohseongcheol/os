...
type TСтандартӣtimereventhandler struct {
}

func (self *TСтандартӣtimereventhandler) Ontick() {
}
...
func (self *TTimerdriver) Init(manager *TInterruptmanager, keyboardeventhandler ITimereventhandler) {
	itimereventhandler = &TСтандартӣtimereventhandler{}
...
func (self *TTimerdriver) Handleinterrupt(esp uint32) uint32 {
	console_2 := TConsole{}
	console_2.MUnsignedinteger32Чопкарданxy(tickcount, 3, 1)
	tickcount++
