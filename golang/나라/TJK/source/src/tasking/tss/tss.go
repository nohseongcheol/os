...
func (self *Tssentry) Сабткунед(gdt *TShareddescriptortable, idx int, kernelss uint32, kernelesp uint32) {

	console_2.MЧопкарданxy(([]byte)("tss:"), 20, 13)
	base := uint32(uintptr(Pointer(self)))
	console_2.MUnsignedinteger32Чопкардан(base)
