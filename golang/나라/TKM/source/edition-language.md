# Turkmenistan (TKM) source language

- country: Turkmenistan (TM)
- selected language: tk_Latn
- CLDR population: 70%
- official status: official
- native language name: Turkmen
- target-language vocabulary: 48
- unresolved source-glossary vocabulary: 823
