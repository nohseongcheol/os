...
func (self *TPort8bit) Ýaz(data uint8) {
	Portoutbyte(self.portnumber, data)
}
func (self *TPort8bit) Oka() uint8 {
	var result = Portinbyte(self.portnumber)
	return result
}
func PortÝazbyte(portnumber uint16, data uint8) {
	Portoutbyte(portnumber, data)
}
func PortOkabyte(portnumber uint16) uint8 {
...
func (self *TPort16bit) Ýaz(data uint16) {
	Portoutword(self.TPort.portnumber, data)
}
func (self *TPort16bit) Oka() uint16 {
	var result = Portinword(self.TPort.portnumber)
	return result
}
func PortÝazword(portnumber uint16, data uint16) {
	Portoutword(portnumber, data)
}
func PortOkaword(portnumber uint16) uint16 {
...
func (self *TPort32bit) Ýaz(data uint32) {
	Portoutdword(self.TPort.portnumber, data)
}
func (self *TPort32bit) Oka() {
	Portindword(self.TPort.portnumber)
}
func PortÝazdword(portnumber uint16, data uint32) {
	Portoutdword(portnumber, data)
}
func PortOkadword(portnumber uint16) uint32 {
	var result uint32 = Portindword(portnumber)
	return result
}

var okacount uint16 = 65
var ýazcount uint16 = 66
