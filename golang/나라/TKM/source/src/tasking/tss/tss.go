...
func (self *Tssentry) Install(gdt *TShareddescriptortable, idx int, kernelss uint32, kernelesp uint32) {

	console_2.MÇapxy(([]byte)("tss:"), 20, 13)
	base := uint32(uintptr(Pointer(self)))
	console_2.MUnsignedinteger32Çap(base)
	console_2.MÇap(":")
