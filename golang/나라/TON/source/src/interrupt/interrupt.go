...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Porttohibyte(Primarypiccommandioport, 0x11)
	Porttohibyte(Secondarypiccommandioport, 0x11)

	Porttohibyte(Primarypicdataioport, 0x20)
	Porttohibyte(Secondarypicdataioport, 0x28)

	Porttohibyte(Primarypicdataioport, 0x04)
	Porttohibyte(Secondarypicdataioport, 0x02)

	Porttohibyte(Primarypicdataioport, 0x01)
	Porttohibyte(Secondarypicdataioport, 0x01)

	Porttohibyte(Primarypicdataioport, 0xF8)
	Porttohibyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Porttohibyte(Secondarypiccommandioport, 0x20)
		}
		Porttohibyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
