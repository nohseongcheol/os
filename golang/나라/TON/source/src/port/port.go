...
func (self *TPort8bit) Tohi(data uint8) {
	Portoutbyte(self.portnumber, data)
}
func (self *TPort8bit) Lau() uint8 {
	var result = Portinbyte(self.portnumber)
	return result
}
func Porttohibyte(portnumber uint16, data uint8) {
	Portoutbyte(portnumber, data)
}
func Portlaubyte(portnumber uint16) uint8 {
...
func (self *TPort16bit) Tohi(data uint16) {
	Portoutword(self.TPort.portnumber, data)
}
func (self *TPort16bit) Lau() uint16 {
	var result = Portinword(self.TPort.portnumber)
	return result
}
func Porttohiword(portnumber uint16, data uint16) {
	Portoutword(portnumber, data)
}
func Portlauword(portnumber uint16) uint16 {
...
func (self *TPort32bit) Tohi(data uint32) {
	Portoutdword(self.TPort.portnumber, data)
}
func (self *TPort32bit) Lau() {
	Portindword(self.TPort.portnumber)
}
func Porttohidword(portnumber uint16, data uint32) {
	Portoutdword(portnumber, data)
}
func Portlaudword(portnumber uint16) uint32 {
	var result uint32 = Portindword(portnumber)
	return result
}

var laucount uint16 = 65
var tohicount uint16 = 66
