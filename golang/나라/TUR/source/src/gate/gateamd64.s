...
GLOBL ·notDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·not<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
TEXT ·kuridt(SB),NOSPLIT,$0
	LEAQ ·notDescriptor<>(SB), AX
...
// used).
TEXT ·HandleKesme(SB),NOSPLIT,$0-10
	...
	LEAQ ·kesmegategirdi(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchKesme(SB),NOSPLIT,$0
...
TEXT ·kesmegategirdi(SB),NOSPLIT,$0
