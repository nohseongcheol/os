...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Porttusitusibyte(Primarypiccommandioport, 0x11)
	Porttusitusibyte(Secondarypiccommandioport, 0x11)

	Porttusitusibyte(Primarypicdataioport, 0x20)
	Porttusitusibyte(Secondarypicdataioport, 0x28)

	Porttusitusibyte(Primarypicdataioport, 0x04)
	Porttusitusibyte(Secondarypicdataioport, 0x02)

	Porttusitusibyte(Primarypicdataioport, 0x01)
	Porttusitusibyte(Secondarypicdataioport, 0x01)

	Porttusitusibyte(Primarypicdataioport, 0xF8)
	Porttusitusibyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Porttusitusibyte(Secondarypiccommandioport, 0x20)
		}
		Porttusitusibyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
