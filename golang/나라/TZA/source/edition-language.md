# Tanzania, United Republic of (TZA) source language

- country: Tanzania, United Republic of (TZ)
- selected language: sw
- CLDR population: 90%
- official status: official
- native language name: Swahili (macrolanguage)
- target-language vocabulary: 4
- unresolved source-glossary vocabulary: 867
