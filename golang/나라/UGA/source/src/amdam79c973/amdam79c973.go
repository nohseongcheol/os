...
func (self *Tamdam79c973) Initdriver(interrupt *TInterruptmanager, devicedescriptor TPeripheralcomponentinterconnectdevicedescriptor, handler IRawdatahandler) {
	...
	var Mac0 uint64 = uint64(Portkusomaword(Macaddress0port) % 256)
	var Mac1 uint64 = uint64(Portkusomaword(Macaddress0port) / 256)
	var Mac2 uint64 = uint64(Portkusomaword(Macaddress2port) % 256)
	var Mac3 uint64 = uint64(Portkusomaword(Macaddress2port) / 256)
	var Mac4 uint64 = uint64(Portkusomaword(Macaddress4port) % 256)
	var Mac5 uint64 = uint64(Portkusomaword(Macaddress4port) / 256)
	...
	Portkuandikaword(registeraddressport, 20)
	Portkuandikaword(buscontrolregisterdataport, 0x102)

	Portkuandikaword(registeraddressport, 0)
	Portkuandikaword(registerdataport, 0x04)
	...
	Portkuandikaword(registeraddressport, 1)
	Portkuandikaword(registerdataport, uint16(uintptr(Pointer(&initblock))&0xFFFF))

	Portkuandikaword(registeraddressport, 2)
	Portkuandikaword(registerdataport, uint16((uintptr(Pointer(&initblock))>>16)&0xFFFF))

}
func (self *Tamdam79c973) Activate() {
	Portkuandikaword(registeraddressport, 0)
	Portkuandikaword(registerdataport, 0x41)

	Portkuandikaword(registeraddressport, 4)
	temporary := Portkusomaword(registerdataport)
	Portkuandikaword(registeraddressport, 4)
	Portkuandikaword(registerdataport, temporary|0xC00)

	Portkuandikaword(registeraddressport, 0)
	Portkuandikaword(registerdataport, 0x42)

}
func (self *Tamdam79c973) Reset() int {
	Portkusomaword(resetport)
	Portkuandikaword(resetport, 0)
	return 10
}
...
func (self *Tamdam79c973) Handleinterrupt(esp uint32) uint32 {
	...
	Portkuandikaword(registeraddressport, 0)
	temporary := uint32(Portkusomaword(registerdataport))
	...
	Portkuandikaword(registeraddressport, 0)
	Portkuandikaword(registerdataport, uint16(temporary))
...
func (self *Tamdam79c973) Send(datapointer uintptr, size uint32) {
	...
	Portkuandikaword(registeraddressport, 0)
	Portkuandikaword(registerdataport, 0x48)
