...
TEXT ·jumpРежимкористувачаiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpРежимкористувачаiret1(SB),NOSPLIT,$0
	RET

TEXT ·threadВийтиloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
...
TEXT ·відновитиfpregs(SB),NOSPLIT,$0
    MOVL ·buffer_2+0(FP), AX
    FXRSTOR (AX)
    RET
