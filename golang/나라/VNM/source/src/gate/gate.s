...
GLOBL ·mãsốtDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·mãsốt<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
TEXT ·càiđặtidt(SB),NOSPLIT,$0
	LEAQ ·mãsốtDescriptor<>(SB), AX
...
// used).
TEXT ·HandleGiánđoạn(SB),NOSPLIT,$0-10
	...
	LEAQ ·giánđoạngateentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchGiánđoạn(SB),NOSPLIT,$0
...
TEXT ·giánđoạngateentry(SB),NOSPLIT,$0
