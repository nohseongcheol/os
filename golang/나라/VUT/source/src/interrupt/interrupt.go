...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portraetembyte(Primarypiccommandioport, 0x11)
	Portraetembyte(Secondarypiccommandioport, 0x11)

	Portraetembyte(Primarypicdataioport, 0x20)
	Portraetembyte(Secondarypicdataioport, 0x28)

	Portraetembyte(Primarypicdataioport, 0x04)
	Portraetembyte(Secondarypicdataioport, 0x02)

	Portraetembyte(Primarypicdataioport, 0x01)
	Portraetembyte(Secondarypicdataioport, 0x01)

	Portraetembyte(Primarypicdataioport, 0xF8)
	Portraetembyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portraetembyte(Secondarypiccommandioport, 0x20)
		}
		Portraetembyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
