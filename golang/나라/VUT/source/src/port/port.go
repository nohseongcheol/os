...
func (self *TPort8bit) Raetem(data uint8) {
	Portoutbyte(self.portnumber, data)
}
func (self *TPort8bit) Ridim() uint8 {
	var result = Portinbyte(self.portnumber)
	return result
}
func Portraetembyte(portnumber uint16, data uint8) {
	Portoutbyte(portnumber, data)
}
func Portridimbyte(portnumber uint16) uint8 {
...
func (self *TPort16bit) Raetem(data uint16) {
	Portoutword(self.TPort.portnumber, data)
}
func (self *TPort16bit) Ridim() uint16 {
	var result = Portinword(self.TPort.portnumber)
	return result
}
func Portraetemword(portnumber uint16, data uint16) {
	Portoutword(portnumber, data)
}
func Portridimword(portnumber uint16) uint16 {
...
func (self *TPort32bit) Raetem(data uint32) {
	Portoutdword(self.TPort.portnumber, data)
}
func (self *TPort32bit) Ridim() {
	Portindword(self.TPort.portnumber)
}
func Portraetemdword(portnumber uint16, data uint32) {
	Portoutdword(portnumber, data)
}
func Portridimdword(portnumber uint16) uint32 {
	var result uint32 = Portindword(portnumber)
	return result
}

var ridimcount uint16 = 65
var raetemcount uint16 = 66
