...
func (self *TInterruptmanager) Init(hardwareinterruptoffset uint16, globaldescriptortable *TShareddescriptortable, taskmanager *TTaskmanager) {
	...
	Portnyorabyte(Primarypiccommandioport, 0x11)
	Portnyorabyte(Secondarypiccommandioport, 0x11)

	Portnyorabyte(Primarypicdataioport, 0x20)
	Portnyorabyte(Secondarypicdataioport, 0x28)

	Portnyorabyte(Primarypicdataioport, 0x04)
	Portnyorabyte(Secondarypicdataioport, 0x02)

	Portnyorabyte(Primarypicdataioport, 0x01)
	Portnyorabyte(Secondarypicdataioport, 0x01)

	Portnyorabyte(Primarypicdataioport, 0xF8)
	Portnyorabyte(Secondarypicdataioport, 0xEF)
...
func (self *TInterruptmanager) Dohandleinterrupt(interrupt uint8, esp uint32) uint32 {
	...
	if 0x20 <= interrupt && interrupt < 0x30 {
		if 0x28 <= interrupt {
			Portnyorabyte(Secondarypiccommandioport, 0x20)
		}
		Portnyorabyte(Primarypiccommandioport, 0x20)
	}
	return esp
}
