# Bosnia and Herzegovina (BIH) source language

- country: Bosnia and Herzegovina (BA)
- selected language: bs_Cyrl
- CLDR population: 99%
- official status: official
- native language name: Bosnian
- target-language vocabulary: 141
- unresolved source-glossary vocabulary: 730
