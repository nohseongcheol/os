...
freestanding library in `./用户空间/posix`.
...
`-I./用户空间/posix/头文件` and link the archive into an EngOS i386 user
...
`./用户空间/posix/TEST_RESULTS.md`. Build all runtime test executables
