...
func (self *TEtherFrameHeader) Vআৰম্ভ_কৰা(buffer TEtherFrameHeaderBuffer) {
...
type IEtherFrameHandler interface {
	Vআৰম্ভ_কৰা(backend TEtherFrameProvider)
	SetHandler(handler IEtherFrameHandler, etherType uint16)
	OnEtherFrameReceived(dataPointer uintptr, আকাৰ int) bool
	Send(dstMAC_BE uint64, dataPointer uintptr, আকাৰ uint32)
	SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, আকাৰ uint32)
...
func (self *TEtherFrameHandler) Vআৰম্ভ_কৰা(backend TEtherFrameProvider) {
	Backend = backend
}
...
func (self *TEtherFrameHandler) OnEtherFrameReceived(dataPointer uintptr, আকাৰ int) bool {
	이더넷콘솔.M출력(([]byte)("OnEtherFrameReceived"))
	return false
}
func (self *TEtherFrameHandler) Send(dstMAC_BE uint64, dataPointer uintptr, আকাৰ uint32) {
	Backend.SendFrame(dstMAC_BE, frame.etherType_BE, dataPointer, আকাৰ)
}
func (self *TEtherFrameHandler) SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, আকাৰ uint32) {
	Backend.SendFrame(dstMAC_BE, etherType_BE, dataPointer, আকাৰ)
}
...
func (self *TEtherFrameRawDataHandler) Vআৰম্ভ_কৰা(p_provider TEtherFrameProvider, p_backend Tamd_am79c973) {
	provider = p_provider
	provider.Vআৰম্ভ_কৰা(p_backend)
}
func (self *TEtherFrameRawDataHandler) OnRawDataReceived(dataPointer uintptr, আকাৰ int) bool {
	return provider.OnRawDataReceived(dataPointer, আকাৰ)
}
func (self *TEtherFrameRawDataHandler) Send(dataPointer uintptr, আকাৰ uint32) {
	provider.Send(dataPointer, আকাৰ)
}
...
func (self *TEtherFrameProvider) Vআৰম্ভ_কৰা(backend Tamd_am79c973) {
...
func (self *TEtherFrameProvider) OnRawDataReceived(dataPointer uintptr, আকাৰ int) bool {
	...
	if frame.dstMAC_BE == 0x0000FFFFFFFFFFFF || Uint48_R(frame.dstMAC_BE) == self.GetMACAddress() {
		if handlers[frame.etherType_BE] != nil {
			...
			var ঠিকনা_সূচক uintptr = uintptr(Pointer(dataPointer)) + uintptr(frameHeaderSize)
			sendBack = handlers[frame.etherType_BE].OnEtherFrameReceived(ঠিকনা_সূচক, আকাৰ-frameHeaderSize)
...
func (self *TEtherFrameProvider) Send(dataPointer uintptr, আকাৰ uint32) {
	self.netCard.Send(dataPointer, আকাৰ)
}
func (self *TEtherFrameProvider) SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, আকাৰ uint32) {
	...
	var ঠিকনা_সূচক uintptr = uintptr(Pointer(&buffer2))

	self.netCard.Send(ঠিকনা_সূচক, আকাৰ+uint32(frameHeaderSize))
