...
func (self *TInternetControlMessageProtocolMessage) Vআৰম্ভ_কৰা(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TICMPHandler) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, আকাৰ uint32) bool {
	return icmp.OnInternetProtocolReceived(srcIP_BE, dstIP_BE, dataPointer, আকাৰ)
}
...
func (self *TInternetControlMessageProtocol) Vআৰম্ভ_কৰা(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vআৰম্ভ_কৰা(backend, handler, 0x01)
	icmp = self
}
func (self *TInternetControlMessageProtocol) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, আকাৰ uint32) bool {
	if আকাৰ < uint32(icmpSize) {
		return false
	}
