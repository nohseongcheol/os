...
func (self *TInterruptHandler) Vআৰম্ভ_কৰা(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vআৰম্ভ_কৰা(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	আকাৰ := (*uint16)(Pointer(&idtPointer[0]))
	(*আকাৰ) = (uint16)(Sizeof(idtData) - 1)
