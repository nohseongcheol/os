...
func (self *TPort8Bit) Vআৰম্ভ_কৰা(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vলিখা(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vপঢ়া() uint8 {
...
func (self *TPort16Bit) Vআৰম্ভ_কৰা(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vলিখা(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vপঢ়া() uint16 {
...
func (self *TPort32Bit) Vআৰম্ভ_কৰা(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vলিখা(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vপঢ়া() {
