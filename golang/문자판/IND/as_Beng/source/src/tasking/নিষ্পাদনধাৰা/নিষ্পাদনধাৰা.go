...
func (self *TThreadHelper) Vআৰম্ভ_কৰা(mem *mem.TMemoryManager) {
	self.mem = mem
	콘솔.M출력XY(([]byte)("thread:"), 1, 14)
}
func (self *TThreadHelper) CreateFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) Tনিষ্পাদনধাৰা {
	result := Tনিষ্পাদনধাৰা{}
...
func (self *TThreadHelper) CreatePtrFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) *Tনিষ্পাদনধাৰা {
	result := (*Tনিষ্পাদনধাৰা)(self.mem.Malloc(uint32(Sizeof(Tনিষ্পাদনধাৰা{}))))
	if result == nil {
		return nil
	}
