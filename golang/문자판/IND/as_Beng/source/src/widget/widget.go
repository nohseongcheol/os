...
type IWidget interface {
	Vআৰম্ভ_কৰা(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
...
func (self *TWidget) Vআৰম্ভ_কৰা(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidgetMouseEventHandler) Vআৰম্ভ_কৰা(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
