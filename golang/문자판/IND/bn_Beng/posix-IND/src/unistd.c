...
{
    return (ssize_t)__syscall_result(SC3(SYS_পড়া, নথি_নির্দেশক, স্থানান্তরের_অস্থায়ী_ভান্ডার, count));
}

ssize_t লেখা(int নথি_নির্দেশক, const void *স্থানান্তরের_অস্থায়ী_ভান্ডার, size_t count)
{
    return (ssize_t)__syscall_result(SC3(SYS_লেখা, নথি_নির্দেশক, স্থানান্তরের_অস্থায়ী_ভান্ডার, count));
}
