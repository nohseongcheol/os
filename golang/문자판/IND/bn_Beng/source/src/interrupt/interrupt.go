...
func (self *TInterruptHandler) Vআরম্ভ_করা(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vআরম্ভ_করা(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	আকার := (*uint16)(Pointer(&idtPointer[0]))
	(*আকার) = (uint16)(Sizeof(idtData) - 1)
