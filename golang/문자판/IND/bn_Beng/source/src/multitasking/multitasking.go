...
func (self *TTask) Vআরম্ভ_করা(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vস্মৃতি_বরাদ্দ_করা(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
