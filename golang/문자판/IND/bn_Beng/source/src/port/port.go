...
func (self *TPort8Bit) Vআরম্ভ_করা(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vলেখা(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vপড়া() uint8 {
...
func (self *TPort16Bit) Vআরম্ভ_করা(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vলেখা(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vপড়া() uint16 {
...
func (self *TPort32Bit) Vআরম্ভ_করা(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vলেখা(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vপড়া() {
