...
type IWidget interface {
	Vআরম্ভ_করা(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vস্থানীয়_স্থানাঙ্ক_রাখা(x int32, y int32)
...
func (self *TWidget) Vআরম্ভ_করা(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vস্থানীয়_স্থানাঙ্ক_রাখা(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vআরম্ভ_করা(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vস্থানীয়_স্থানাঙ্ক_রাখা(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vস্থানীয়_স্থানাঙ্ক_রাখা(uint32(xPos), uint32(yPos))
