...
func (self *TPort8Bit) Vलिरनाय(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vफरायनाय() uint8 {
...
func (self *TPort16Bit) Vलिरनाय(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vफरायनाय() uint16 {
...
func (self *TPort32Bit) Vलिरनाय(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vफरायनाय() {
