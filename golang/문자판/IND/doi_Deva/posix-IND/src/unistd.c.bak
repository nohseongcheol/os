...
ssize_t पढ़ना(int fd, void *buf, size_t count)
{
    return (ssize_t)__syscall_result(SC3(SYS_पढ़ना, fd, buf, count));
}

ssize_t लिखना(int fd, const void *buf, size_t count)
{
    return (ssize_t)__syscall_result(SC3(SYS_लिखना, fd, buf, count));
}
