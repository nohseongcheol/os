...
func (self *TTask) Vઆરંભ_કરવો(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vસ્મૃતિ_ફાળવવી(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
