...
func (self *TPort8Bit) Vઆરંભ_કરવો(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vલખવું(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vવાંચવું() uint8 {
...
func (self *TPort16Bit) Vઆરંભ_કરવો(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vલખવું(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vવાંચવું() uint16 {
...
func (self *TPort32Bit) Vઆરંભ_કરવો(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vલખવું(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vવાંચવું() {
