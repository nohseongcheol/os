...
func (self *TARPMessage) Vआरंभ_करना(buffer *TARPMessageBuffer) {
...
func (self *TARPProvider) Vआरंभ_करना(backend TEtherFrameProvider, userhandler IEtherFrameHandler) {

	handler = userhandler
	handler.Vआरंभ_करना(backend)
...
func (self *TARPProvider) BroadcastMacAddress(IP_BE uint32) {
	...
	var पता_संदर्भ uintptr = uintptr(Pointer(&arpBuffer))
	handler.Send(arp.dstMAC, पता_संदर्भ, arpMesgSize)
}
