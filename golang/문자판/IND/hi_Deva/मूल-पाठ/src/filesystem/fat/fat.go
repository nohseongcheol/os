...
func (self *TBiosParameterBlock32) Vआरंभ_करना(data []byte) {
...
func (self *TBiosParameterBlock32) Len(hd *TAdvancedTechnologyAttachment, partEntry TPartitionTableEntry, filename []byte) uint32 {
	...
	bpbPtr := memoryManager.Vस्मृति_आवंटित_करना(90)
	...
	direntPtr := memoryManager.Vस्मृति_आवंटित_करना(512)
	...
	for i := 0; i < 16; i++ {
		...
		memoryManager.Vस्मृति_मुक्त_करना(bpbPtr)
		memoryManager.Vस्मृति_मुक्त_करना(direntPtr)
...
func (self *TBiosParameterBlock32) Vपढ़ना(hd *TAdvancedTechnologyAttachment, partEntry TPartitionTableEntry, filename []byte, data []byte) {
...
func (self *TDirectoryEntryFat32) Vआरंभ_करना(data [32]byte) {
