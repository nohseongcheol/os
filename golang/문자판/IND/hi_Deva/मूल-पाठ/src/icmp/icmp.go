...
func (self *TInternetControlMessageProtocolMessage) Vआरंभ_करना(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TInternetControlMessageProtocol) Vआरंभ_करना(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vआरंभ_करना(backend, handler, 0x01)
	icmp = self
}
...
func (self *TInternetControlMessageProtocol) SendEchoRequest(ip_be uint32) bool {
	...
	var buffer = (*TInternetControlMessageProtocolMessageBuffer)(memoryManager.Vस्मृति_आवंटित_करना(1024))
