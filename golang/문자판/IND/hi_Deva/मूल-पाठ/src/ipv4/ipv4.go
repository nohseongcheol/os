...
func (self *TInternetProtocolV4Message) Vआरंभ_करना(buffer TInternetProtocolV4MessageBuffer) {
...
type IInternetProtocolHandler interface {
	Vआरंभ_करना(backend TInternetProtocolProvider, p_iHandler IInternetProtocolHandler, p_protocol uint8)
...
func (self *TInternetProtocolHandler) Vआरंभ_करना(backend TInternetProtocolProvider, p_iHandler IInternetProtocolHandler, p_protocol uint8) {
	protocol = p_protocol
...
func (self *TInternetProtocolProvider) Vआरंभ_करना(p_efProvider TEtherFrameProvider, p_efHandler IEtherFrameHandler, arp TARPProvider, gatewayIP uint32, subnetMask uint32) {
