...
func (self *TThreadHelper) Vआरंभ_करना(mem *mem.TMemoryManager) {
	self.mem = mem
	콘솔.M출력XY(([]byte)("thread:"), 1, 14)
}
func (self *TThreadHelper) CreateFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) Tनिष्पादन_धारा {
	result := Tनिष्पादन_धारा{}

	result.Stack = uint32(uintptr(self.mem.Vस्मृति_आवंटित_करना(THREAD_STACK_SIZE)))
	if result.Stack == 0 {
		return result
	}
	콘솔.M출력(([]byte)("[mem:"))
...
func (self *TThreadHelper) CreatePtrFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) *Tनिष्पादन_धारा {
	result := (*Tनिष्पादन_धारा)(self.mem.Vस्मृति_आवंटित_करना(uint32(Sizeof(Tनिष्पादन_धारा{}))))
	if result == nil {
		return nil
	}
	*result = self.CreateFromFunction(entrypoint, PageDirEntry, isKernel)
	if result.CpuState == nil {
		self.mem.Vस्मृति_मुक्त_करना(Pointer(result))
		return nil
	}
	return result
}
