...
func (self *TUserDatagramProtocolHeader) Vआरंभ_करना(buffer *TUserDatagramProtocolHeaderBuffer) {
...
func (self *TUserDatagramProtocolHandler) Vआरंभ_करना(backend TInternetProtocolProvider) {
}
...
func (self *TUserDatagramProtocolSocket) Vआरंभ_करना(p_udpProvider TUserDatagramProtocolProvider, p_udpHandler IUserDatagramProtocolHandler) {
...
func (self *TUserDatagramProtocolProvider) Vआरंभ_करना(p_ipProvider TInternetProtocolProvider, p_ipHandler IInternetProtocolHandler) {
	ipHandler = p_ipHandler
	ipHandler.Vआरंभ_करना(p_ipProvider, p_ipHandler, 0x11)
	numSockets = 0
	freePort = 1024
}
...
func (self *TUserDatagramProtocolProvider) Connect(ip uint32, port uint16) *TUserDatagramProtocolSocket {
	...
	var socket = (*TUserDatagramProtocolSocket)(memoryManager.Vस्मृति_आवंटित_करना(50))

	if socket != nil {

		socket.Vआरंभ_करना(*self, nil)
