...
func (self *LinkedList) Vआरंभ_करना(mem *mem.TMemoryManager) {
	self.head = nil
	self.tail = nil
	self.Vआकार = 0
...
func (self *LinkedList) Vसूची_के_आरंभ_में_जोड़ना(पता_संदर्भ uintptr) {
	newNode := (*Node)(self.mem.Vस्मृति_आवंटित_करना(uint32(Sizeof(Node{}))))
	if newNode == nil {
		return
	}
...
func (self *LinkedList) Vसूची_के_अंत_में_जोड़ना(पता_संदर्भ uintptr) {
	if self.Vआकार == 0 {
		self.Vसूची_के_आरंभ_में_जोड़ना(पता_संदर्भ)
	} else {
		newNode := (*Node)(self.mem.Vस्मृति_आवंटित_करना(uint32(Sizeof(Node{}))))
		if newNode == nil {
			return
...
func (self *LinkedList) RemoveAt(index int) {
	...
	if self.mem != nil {
		self.mem.Vस्मृति_मुक्त_करना(Pointer(node))
	}
}
