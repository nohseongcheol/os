...
func (self *TMemoryManager) Vआरंभ_करना(start uint32, आकार uint32) {
...
func (self *TMemoryManager) Vस्मृति_आवंटित_करना(आकार uint32) Pointer {
...
func (self *TMemoryManager) Vस्मृति_मुक्त_करना(पता_संदर्भ_2 Pointer) {
	var chunk *TMemoryChunk = (*TMemoryChunk)(Pointer(uintptr(पता_संदर्भ_2) - uintptr(memoryChunkSize)))
...
func New(आकार int) Pointer {
	...
	return ActiveMemoryManager.Vस्मृति_आवंटित_करना(uint32(आकार))
}
func Delete(पता_संदर्भ_2 Pointer) {
	if ActiveMemoryManager != nil {
		ActiveMemoryManager.Vस्मृति_मुक्त_करना(पता_संदर्भ_2)
	}
}
