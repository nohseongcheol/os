...
func (self *TInterruptHandler) Vಆರಂಭಿಸು(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vಆರಂಭಿಸು(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	ಗಾತ್ರ := (*uint16)(Pointer(&idtPointer[0]))
	(*ಗಾತ್ರ) = (uint16)(Sizeof(idtData) - 1)
