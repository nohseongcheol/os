...
func (self *TTask) Vಆರಂಭಿಸು(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vಸ್ಮೃತಿಯನ್ನು_ಹಂಚು(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
