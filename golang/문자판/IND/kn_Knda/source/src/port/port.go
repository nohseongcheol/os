...
func (self *TPort8Bit) Vಆರಂಭಿಸು(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vಬರೆ(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vಓದು() uint8 {
...
func (self *TPort16Bit) Vಆರಂಭಿಸು(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vಬರೆ(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vಓದು() uint16 {
...
func (self *TPort32Bit) Vಆರಂಭಿಸು(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vಬರೆ(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vಓದು() {
