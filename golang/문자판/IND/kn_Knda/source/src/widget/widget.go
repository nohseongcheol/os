...
type IWidget interface {
	Vಆರಂಭಿಸು(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vಸ್ಥಳೀಯ_ನಿರ್ದೇಶಾಂಕಗಳನ್ನು_ಹೊಂದಿಸು(x int32, y int32)
...
func (self *TWidget) Vಆರಂಭಿಸು(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vಸ್ಥಳೀಯ_ನಿರ್ದೇಶಾಂಕಗಳನ್ನು_ಹೊಂದಿಸು(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vಆರಂಭಿಸು(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vಸ್ಥಳೀಯ_ನಿರ್ದೇಶಾಂಕಗಳನ್ನು_ಹೊಂದಿಸು(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vಸ್ಥಳೀಯ_ನಿರ್ದೇಶಾಂಕಗಳನ್ನು_ಹೊಂದಿಸು(uint32(xPos), uint32(yPos))
