...
func (self *TPort8Bit) Vबरोवप(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vवाचप() uint8 {
...
func (self *TPort16Bit) Vबरोवप(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vवाचप() uint16 {
...
func (self *TPort32Bit) Vबरोवप(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vवाचप() {
