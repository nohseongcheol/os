...
func (self *TARPMessage) Init(buffer *TARPMessageBuffer) {
...
func (self *TARPEtherFrameHandler) Send(dstMAC_BE uint64, dataPointer uintptr, size uint32) {
	...
	self.TEtherFrameHandler.SendFrame(dstMAC_BE, etherType_BE, dataPointer, size)
}
...
func (self *TARPProvider) Init(backend TEtherFrameProvider, userhandler IEtherFrameHandler) {
...
func (self *TARPProvider) OnEtherFrameReceived(dataPointer uintptr, size uint32) bool {
...
func (self *TARPProvider) TestPrint(data *[]byte, size uint32) {
