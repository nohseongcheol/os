...
func (self *TPort8Bit) Vborovop(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vvachop() uint8 {
...
func (self *TPort16Bit) Vborovop(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vvachop() uint16 {
...
func (self *TPort32Bit) Vborovop(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vvachop() {
