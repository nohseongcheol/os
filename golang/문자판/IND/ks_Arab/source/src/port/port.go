...
func (self *TPort8Bit) Vلِکھُن(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vپَرُن() uint8 {
...
func (self *TPort16Bit) Vلِکھُن(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vپَرُن() uint16 {
...
func (self *TPort32Bit) Vلِکھُن(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vپَرُن() {
