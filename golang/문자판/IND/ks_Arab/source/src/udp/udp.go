...
func (self *TUserDatagramProtocolHeader) Init(buffer *TUserDatagramProtocolHeaderBuffer) {
...
func (self *TUserDatagramProtocolSocket) Init(p_udpProvider TUserDatagramProtocolProvider, p_udpHandler IUserDatagramProtocolHandler) {
...
func (self *TUserDatagramProtocolSocket) Send(p_data []byte, size uint16) {
...
func (self *TUserDatagramProtocolProvider) Init(p_ipProvider TInternetProtocolProvider, p_ipHandler IInternetProtocolHandler) {
	ipHandler = p_ipHandler
	ipHandler.Init(p_ipProvider, p_ipHandler, 0x11)
	numSockets = 0
	freePort = 1024
}
func (self *TUserDatagramProtocolProvider) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, internetprotocolPayload uintptr, size uint32) bool {
...
func (self *TUserDatagramProtocolProvider) Send(socket *TUserDatagramProtocolSocket, p_data uintptr, size uint16) {
