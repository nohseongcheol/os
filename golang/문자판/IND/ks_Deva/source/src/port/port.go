...
func (self *TPort8Bit) Vलिखुन(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vपरुन() uint8 {
...
func (self *TPort16Bit) Vलिखुन(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vपरुन() uint16 {
...
func (self *TPort32Bit) Vलिखुन(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vपरुन() {
