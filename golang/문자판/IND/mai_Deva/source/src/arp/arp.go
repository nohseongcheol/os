...
func (self *TARPMessage) Vआरंभ_करब(buffer *TARPMessageBuffer) {
...
func (self *TARPProvider) Vआरंभ_करब(backend TEtherFrameProvider, userhandler IEtherFrameHandler) {

	handler = userhandler
	handler.Vआरंभ_करब(backend)
