...
func (self *TEtherFrameHeader) Vआरंभ_करब(buffer TEtherFrameHeaderBuffer) {
...
type IEtherFrameHandler interface {
	Vआरंभ_करब(backend TEtherFrameProvider)
...
func (self *TEtherFrameHandler) Vआरंभ_करब(backend TEtherFrameProvider) {
	Backend = backend
}
...
func (self *TEtherFrameRawDataHandler) Vआरंभ_करब(p_provider TEtherFrameProvider, p_backend Tamd_am79c973) {
	provider = p_provider
	provider.Vआरंभ_करब(p_backend)
}
...
func (self *TEtherFrameProvider) Vआरंभ_करब(backend Tamd_am79c973) {
