...
func (self *TBiosParameterBlock32) Vआरंभ_करब(data []byte) {
...
func (self *TBiosParameterBlock32) Vपढ़ब(hd *TAdvancedTechnologyAttachment, partEntry TPartitionTableEntry, filename []byte, data []byte) {
...
func (self *TDirectoryEntryFat32) Vआरंभ_करब(data [32]byte) {
