...
func (self *TInternetControlMessageProtocolMessage) Vआरंभ_करब(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TInternetControlMessageProtocol) Vआरंभ_करब(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vआरंभ_करब(backend, handler, 0x01)
	icmp = self
}
