...
func (self *TInterruptHandler) Vआरंभ_करब(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vआरंभ_करब(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
