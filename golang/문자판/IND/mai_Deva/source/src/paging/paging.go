...
func (self *TCOWFrameManager) Vआरंभ_करब(mem *TMemoryManager, frameCount uint32) bool {
	self.mem = mem
...
func (self *Paging) Vआरंभ_करब(pageDirEntry uintptr, pageTableEntry uint32, memoryManager *TMemoryManager) {
	...
	cowFrameManager.Vआरंभ_करब(memoryManager, (512*1024*1024)>>12)
...
func (self *Paging) PageFault(manager *TInterruptManager) {
	...
	self.TInterruptHandler.Vआरंभ_करब(0xE, uintptr(unsafe.Pointer(manager)), addr)
}
