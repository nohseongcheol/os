...
func (self *TPort8Bit) Vआरंभ_करब(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vलिखब(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vपढ़ब() uint8 {
...
func (self *TPort16Bit) Vआरंभ_करब(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vलिखब(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vपढ़ब() uint16 {
...
func (self *TPort32Bit) Vआरंभ_करब(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vलिखब(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vपढ़ब() {
