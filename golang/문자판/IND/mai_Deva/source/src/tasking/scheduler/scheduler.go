...
func (self *SchedulerData) Vआरंभ_करब() {
...
func (self *Scheduler) Vआरंभ_करब(manager *TInterruptManager, mem *mem.TMemoryManager, tss *TSSEntry) {
	sche_data.Vआरंभ_करब()
	sche_data.tss = tss
	...
	self.TInterruptHandler.Vआरंभ_करब(0x20, uintptr(Pointer(manager)), addr)
}
