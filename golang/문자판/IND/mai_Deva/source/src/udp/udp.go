...
func (self *TUserDatagramProtocolHeader) Vआरंभ_करब(buffer *TUserDatagramProtocolHeaderBuffer) {
...
func (self *TUserDatagramProtocolHandler) Vआरंभ_करब(backend TInternetProtocolProvider) {
}
...
func (self *TUserDatagramProtocolSocket) Vआरंभ_करब(p_udpProvider TUserDatagramProtocolProvider, p_udpHandler IUserDatagramProtocolHandler) {
...
func (self *TUserDatagramProtocolProvider) Vआरंभ_करब(p_ipProvider TInternetProtocolProvider, p_ipHandler IInternetProtocolHandler) {
	ipHandler = p_ipHandler
	ipHandler.Vआरंभ_करब(p_ipProvider, p_ipHandler, 0x11)
	numSockets = 0
	freePort = 1024
}
