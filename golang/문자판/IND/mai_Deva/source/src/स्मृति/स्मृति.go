...
func (self *TMemoryManager) Vआरंभ_करब(start uint32, आकार uint32) {
...
func (self *TMemoryManager) Malloc(आकार uint32) Pointer {
...
func (self *TMemoryManager) Free(पता_संदर्भ_2 Pointer) {
...
func New(आकार int) Pointer {
	...
	return ActiveMemoryManager.Malloc(uint32(आकार))
}
func Delete(पता_संदर्भ_2 Pointer) {
	if ActiveMemoryManager != nil {
		ActiveMemoryManager.Free(पता_संदर्भ_2)
	}
}
