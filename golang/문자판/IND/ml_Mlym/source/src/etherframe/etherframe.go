...
func (self *TEtherFrameHeader) Vആരംഭിക്കുക(buffer TEtherFrameHeaderBuffer) {
...
type IEtherFrameHandler interface {
	Vആരംഭിക്കുക(backend TEtherFrameProvider)
	SetHandler(handler IEtherFrameHandler, etherType uint16)
	OnEtherFrameReceived(dataPointer uintptr, വലുപ്പം int) bool
	Send(dstMAC_BE uint64, dataPointer uintptr, വലുപ്പം uint32)
	SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, വലുപ്പം uint32)
...
func (self *TEtherFrameHandler) Vആരംഭിക്കുക(backend TEtherFrameProvider) {
	Backend = backend
}
...
func (self *TEtherFrameHandler) OnEtherFrameReceived(dataPointer uintptr, വലുപ്പം int) bool {
	이더넷콘솔.M출력(([]byte)("OnEtherFrameReceived"))
	return false
}
func (self *TEtherFrameHandler) Send(dstMAC_BE uint64, dataPointer uintptr, വലുപ്പം uint32) {
	Backend.SendFrame(dstMAC_BE, frame.etherType_BE, dataPointer, വലുപ്പം)
}
func (self *TEtherFrameHandler) SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, വലുപ്പം uint32) {
	Backend.SendFrame(dstMAC_BE, etherType_BE, dataPointer, വലുപ്പം)
}
...
func (self *TEtherFrameRawDataHandler) Vആരംഭിക്കുക(p_provider TEtherFrameProvider, p_backend Tamd_am79c973) {
	provider = p_provider
	provider.Vആരംഭിക്കുക(p_backend)
}
func (self *TEtherFrameRawDataHandler) OnRawDataReceived(dataPointer uintptr, വലുപ്പം int) bool {
	return provider.OnRawDataReceived(dataPointer, വലുപ്പം)
}
func (self *TEtherFrameRawDataHandler) Send(dataPointer uintptr, വലുപ്പം uint32) {
	provider.Send(dataPointer, വലുപ്പം)
}
...
func (self *TEtherFrameProvider) Vആരംഭിക്കുക(backend Tamd_am79c973) {
...
func (self *TEtherFrameProvider) OnRawDataReceived(dataPointer uintptr, വലുപ്പം int) bool {
	...
	if frame.dstMAC_BE == 0x0000FFFFFFFFFFFF || Uint48_R(frame.dstMAC_BE) == self.GetMACAddress() {
		if handlers[frame.etherType_BE] != nil {
			...
			var വിലാസ_സൂചിക uintptr = uintptr(Pointer(dataPointer)) + uintptr(frameHeaderSize)
			sendBack = handlers[frame.etherType_BE].OnEtherFrameReceived(വിലാസ_സൂചിക, വലുപ്പം-frameHeaderSize)
...
func (self *TEtherFrameProvider) Send(dataPointer uintptr, വലുപ്പം uint32) {
	self.netCard.Send(dataPointer, വലുപ്പം)
}
func (self *TEtherFrameProvider) SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, വലുപ്പം uint32) {
	...
	var വിലാസ_സൂചിക uintptr = uintptr(Pointer(&buffer2))

	self.netCard.Send(വിലാസ_സൂചിക, വലുപ്പം+uint32(frameHeaderSize))
