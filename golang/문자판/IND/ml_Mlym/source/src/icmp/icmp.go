...
func (self *TInternetControlMessageProtocolMessage) Vആരംഭിക്കുക(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TICMPHandler) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, വലുപ്പം uint32) bool {
	return icmp.OnInternetProtocolReceived(srcIP_BE, dstIP_BE, dataPointer, വലുപ്പം)
}
...
func (self *TInternetControlMessageProtocol) Vആരംഭിക്കുക(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vആരംഭിക്കുക(backend, handler, 0x01)
	icmp = self
}
func (self *TInternetControlMessageProtocol) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, വലുപ്പം uint32) bool {
	if വലുപ്പം < uint32(icmpSize) {
		return false
	}
...
func (self *TInternetControlMessageProtocol) SendEchoRequest(ip_be uint32) bool {
	...
	var buffer = (*TInternetControlMessageProtocolMessageBuffer)(memoryManager.Vഓർമ്മസ്ഥലം_അനുവദിക്കുക(1024))
