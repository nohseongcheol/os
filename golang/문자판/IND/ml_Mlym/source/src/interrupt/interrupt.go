...
func (self *TInterruptHandler) Vആരംഭിക്കുക(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vആരംഭിക്കുക(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	വലുപ്പം := (*uint16)(Pointer(&idtPointer[0]))
	(*വലുപ്പം) = (uint16)(Sizeof(idtData) - 1)
