...
func (self *TTask) Vആരംഭിക്കുക(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vഓർമ്മസ്ഥലം_അനുവദിക്കുക(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
