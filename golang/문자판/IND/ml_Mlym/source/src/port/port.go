...
func (self *TPort8Bit) Vആരംഭിക്കുക(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vഎഴുതുക(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vവായിക്കുക() uint8 {
...
func (self *TPort16Bit) Vആരംഭിക്കുക(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vഎഴുതുക(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vവായിക്കുക() uint16 {
...
func (self *TPort32Bit) Vആരംഭിക്കുക(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vഎഴുതുക(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vവായിക്കുക() {
