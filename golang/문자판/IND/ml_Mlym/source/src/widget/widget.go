...
type IWidget interface {
	Vആരംഭിക്കുക(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vപ്രാദേശിക_നിർദ്ദേശാങ്കങ്ങൾ_സജ്ജമാക്കുക(x int32, y int32)
...
func (self *TWidget) Vആരംഭിക്കുക(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vപ്രാദേശിക_നിർദ്ദേശാങ്കങ്ങൾ_സജ്ജമാക്കുക(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vആരംഭിക്കുക(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vപ്രാദേശിക_നിർദ്ദേശാങ്കങ്ങൾ_സജ്ജമാക്കുക(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vപ്രാദേശിക_നിർദ്ദേശാങ്കങ്ങൾ_സജ്ജമാക്കുക(uint32(xPos), uint32(yPos))
