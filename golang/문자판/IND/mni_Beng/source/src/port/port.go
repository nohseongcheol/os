...
func (self *TPort8Bit) Vইবা(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vপাবা() uint8 {
...
func (self *TPort16Bit) Vইবা(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vপাবা() uint16 {
...
func (self *TPort32Bit) Vইবা(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vপাবা() {
