...
func (self *TPort8Bit) Vꯏꯕ(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vꯄꯥꯕ() uint8 {
...
func (self *TPort16Bit) Vꯏꯕ(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vꯄꯥꯕ() uint16 {
...
func (self *TPort32Bit) Vꯏꯕ(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vꯄꯥꯕ() {
