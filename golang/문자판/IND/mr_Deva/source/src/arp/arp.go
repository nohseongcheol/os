...
func (self *TARPMessage) Vआरंभ_करणे(buffer *TARPMessageBuffer) {
...
func (self *TARPProvider) Vआरंभ_करणे(backend TEtherFrameProvider, userhandler IEtherFrameHandler) {

	handler = userhandler
	handler.Vआरंभ_करणे(backend)
...
func (self *TARPProvider) BroadcastMacAddress(IP_BE uint32) {
	...
	var पत्ता_संदर्भ uintptr = uintptr(Pointer(&arpBuffer))
	handler.Send(arp.dstMAC, पत्ता_संदर्भ, arpMesgSize)
}
