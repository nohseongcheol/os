...
func (self *TBiosParameterBlock32) Vआरंभ_करणे(data []byte) {
...
func (self *TBiosParameterBlock32) Len(hd *TAdvancedTechnologyAttachment, partEntry TPartitionTableEntry, filename []byte) uint32 {
	...
	bpbPtr := memoryManager.Vस्मृती_वाटप_करणे(90)
	...
	direntPtr := memoryManager.Vस्मृती_वाटप_करणे(512)
	...
	for i := 0; i < 16; i++ {
		...
		memoryManager.Vस्मृती_मुक्त_करणे(bpbPtr)
		memoryManager.Vस्मृती_मुक्त_करणे(direntPtr)
...
func (self *TBiosParameterBlock32) Vवाचणे(hd *TAdvancedTechnologyAttachment, partEntry TPartitionTableEntry, filename []byte, data []byte) {
...
func (self *TDirectoryEntryFat32) Vआरंभ_करणे(data [32]byte) {
