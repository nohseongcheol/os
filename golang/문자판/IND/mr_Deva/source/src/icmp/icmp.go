...
func (self *TInternetControlMessageProtocolMessage) Vआरंभ_करणे(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TInternetControlMessageProtocol) Vआरंभ_करणे(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vआरंभ_करणे(backend, handler, 0x01)
	icmp = self
}
...
func (self *TInternetControlMessageProtocol) SendEchoRequest(ip_be uint32) bool {
	...
	var buffer = (*TInternetControlMessageProtocolMessageBuffer)(memoryManager.Vस्मृती_वाटप_करणे(1024))
