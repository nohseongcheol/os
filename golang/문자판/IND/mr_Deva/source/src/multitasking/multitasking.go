...
func (self *TTask) Vआरंभ_करणे(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vस्मृती_वाटप_करणे(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
