...
func (self *TArray) Add(पत्ता_संदर्भ uintptr) {
	nodeArray[self.Vआकार] = पत्ता_संदर्भ
	self.Vआकार++
}
func (self *TArray) GetAt(index int) Pointer {
	return Pointer(nodeArray[index])
}
func (self *TArray) IndexOf(पत्ता_संदर्भ uintptr) int {
	i := 0
	for ; i < self.Vआकार; i++ {
		if पत्ता_संदर्भ == nodeArray[i] {
			return i
		}
	}
	return -1
