...
type IWidget interface {
	Vआरंभ_करणे(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vस्थानिक_निर्देशांक_ठेवणे(x int32, y int32)
...
func (self *TWidget) Vआरंभ_करणे(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vस्थानिक_निर्देशांक_ठेवणे(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vआरंभ_करणे(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vस्थानिक_निर्देशांक_ठेवणे(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vस्थानिक_निर्देशांक_ठेवणे(uint32(xPos), uint32(yPos))
