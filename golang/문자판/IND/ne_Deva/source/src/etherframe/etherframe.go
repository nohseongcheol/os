...
func (self *TEtherFrameHeader) Vआरम्भ_गर्नु(buffer TEtherFrameHeaderBuffer) {
...
type IEtherFrameHandler interface {
	Vआरम्भ_गर्नु(backend TEtherFrameProvider)
	SetHandler(handler IEtherFrameHandler, etherType uint16)
	OnEtherFrameReceived(dataPointer uintptr, आकार int) bool
	Send(dstMAC_BE uint64, dataPointer uintptr, आकार uint32)
	SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, आकार uint32)
...
func (self *TEtherFrameHandler) Vआरम्भ_गर्नु(backend TEtherFrameProvider) {
	Backend = backend
}
...
func (self *TEtherFrameHandler) OnEtherFrameReceived(dataPointer uintptr, आकार int) bool {
	이더넷콘솔.M출력(([]byte)("OnEtherFrameReceived"))
	return false
}
func (self *TEtherFrameHandler) Send(dstMAC_BE uint64, dataPointer uintptr, आकार uint32) {
	Backend.SendFrame(dstMAC_BE, frame.etherType_BE, dataPointer, आकार)
}
func (self *TEtherFrameHandler) SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, आकार uint32) {
	Backend.SendFrame(dstMAC_BE, etherType_BE, dataPointer, आकार)
}
...
func (self *TEtherFrameRawDataHandler) Vआरम्भ_गर्नु(p_provider TEtherFrameProvider, p_backend Tamd_am79c973) {
	provider = p_provider
	provider.Vआरम्भ_गर्नु(p_backend)
}
func (self *TEtherFrameRawDataHandler) OnRawDataReceived(dataPointer uintptr, आकार int) bool {
	return provider.OnRawDataReceived(dataPointer, आकार)
}
func (self *TEtherFrameRawDataHandler) Send(dataPointer uintptr, आकार uint32) {
	provider.Send(dataPointer, आकार)
}
...
func (self *TEtherFrameProvider) Vआरम्भ_गर्नु(backend Tamd_am79c973) {
...
func (self *TEtherFrameProvider) OnRawDataReceived(dataPointer uintptr, आकार int) bool {
	...
	if frame.dstMAC_BE == 0x0000FFFFFFFFFFFF || Uint48_R(frame.dstMAC_BE) == self.GetMACAddress() {
		if handlers[frame.etherType_BE] != nil {
			...
			var ठेगाना_सूचक uintptr = uintptr(Pointer(dataPointer)) + uintptr(frameHeaderSize)
			sendBack = handlers[frame.etherType_BE].OnEtherFrameReceived(ठेगाना_सूचक, आकार-frameHeaderSize)
...
func (self *TEtherFrameProvider) Send(dataPointer uintptr, आकार uint32) {
	self.netCard.Send(dataPointer, आकार)
}
func (self *TEtherFrameProvider) SendFrame(dstMAC_BE uint64, etherType_BE uint16, dataPointer uintptr, आकार uint32) {
	...
	var ठेगाना_सूचक uintptr = uintptr(Pointer(&buffer2))

	self.netCard.Send(ठेगाना_सूचक, आकार+uint32(frameHeaderSize))
