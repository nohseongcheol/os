...
func (self *TInternetControlMessageProtocolMessage) Vआरम्भ_गर्नु(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TICMPHandler) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, आकार uint32) bool {
	return icmp.OnInternetProtocolReceived(srcIP_BE, dstIP_BE, dataPointer, आकार)
}
...
func (self *TInternetControlMessageProtocol) Vआरम्भ_गर्नु(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vआरम्भ_गर्नु(backend, handler, 0x01)
	icmp = self
}
func (self *TInternetControlMessageProtocol) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, आकार uint32) bool {
	if आकार < uint32(icmpSize) {
		return false
	}
...
func (self *TInternetControlMessageProtocol) SendEchoRequest(ip_be uint32) bool {
	...
	var buffer = (*TInternetControlMessageProtocolMessageBuffer)(memoryManager.Vस्मृति_छुट्याउनु(1024))
