...
func (self *TInterruptHandler) Vआरम्भ_गर्नु(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vआरम्भ_गर्नु(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	आकार := (*uint16)(Pointer(&idtPointer[0]))
	(*आकार) = (uint16)(Sizeof(idtData) - 1)
