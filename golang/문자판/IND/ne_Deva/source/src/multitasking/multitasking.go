...
func (self *TTask) Vआरम्भ_गर्नु(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vस्मृति_छुट्याउनु(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
