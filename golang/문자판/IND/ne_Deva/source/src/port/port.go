...
func (self *TPort8Bit) Vआरम्भ_गर्नु(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vलेख्नु(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vपढ्नु() uint8 {
...
func (self *TPort16Bit) Vआरम्भ_गर्नु(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vलेख्नु(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vपढ्नु() uint16 {
...
func (self *TPort32Bit) Vआरम्भ_गर्नु(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vलेख्नु(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vपढ्नु() {
