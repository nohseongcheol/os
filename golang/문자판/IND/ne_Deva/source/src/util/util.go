...
func GetUintptrArrayFromPtr(ठेगाना_सूचक_2 uintptr, len int, cap int) []uintptr {
	len = len * 4
	cap = cap * 4
	var sl = struct {
		addr	uintptr
		len	int
		cap	int
	}{ठेगाना_सूचक_2, len, cap}
	return *(*[]uintptr)(Pointer(&sl))
}
func GetUint32ArrayFromPtr(ठेगाना_सूचक_2 uintptr, len int, cap int) []uint32 {
	len = len * 4
	cap = cap * 4
	var sl = struct {
		addr	uintptr
...
func GetBytesFromPtr(ठेगाना_सूचक_2 uintptr, len int, cap int) []byte {
	var sl = struct {
		addr	uintptr
		len	int
		cap	int
...
func GetFuncPtrFromPtr(ठेगाना_सूचक_2 uintptr) func() {
	code1ptr := uintptr(Pointer(&ठेगाना_सूचक_2))
