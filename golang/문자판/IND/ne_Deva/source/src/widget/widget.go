...
type IWidget interface {
	Vआरम्भ_गर्नु(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vस्थानीय_निर्देशाङ्क_राख्नु(x int32, y int32)
...
func (self *TWidget) Vआरम्भ_गर्नु(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vस्थानीय_निर्देशाङ्क_राख्नु(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vआरम्भ_गर्नु(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vस्थानीय_निर्देशाङ्क_राख्नु(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vस्थानीय_निर्देशाङ्क_राख्नु(uint32(xPos), uint32(yPos))
