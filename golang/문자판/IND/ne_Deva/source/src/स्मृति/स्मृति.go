...
func (self *TMemoryManager) Vआरम्भ_गर्नु(start uint32, आकार uint32) {
...
func (self *TMemoryManager) Vस्मृति_छुट्याउनु(आकार uint32) Pointer {
...
func (self *TMemoryManager) Vस्मृति_मुक्त_गर्नु(ठेगाना_सूचक_2 Pointer) {
	var chunk *TMemoryChunk = (*TMemoryChunk)(Pointer(uintptr(ठेगाना_सूचक_2) - uintptr(memoryChunkSize)))
...
func New(आकार int) Pointer {
	...
	return ActiveMemoryManager.Vस्मृति_छुट्याउनु(uint32(आकार))
}
func Delete(ठेगाना_सूचक_2 Pointer) {
	if ActiveMemoryManager != nil {
		ActiveMemoryManager.Vस्मृति_मुक्त_गर्नु(ठेगाना_सूचक_2)
	}
}
