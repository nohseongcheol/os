...
func (self *TInterruptHandler) Vଆରମ୍ଭ_କରିବା(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vଆରମ୍ଭ_କରିବା(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	ଆକାର := (*uint16)(Pointer(&idtPointer[0]))
	(*ଆକାର) = (uint16)(Sizeof(idtData) - 1)
