...
func (self *TPort8Bit) Vଆରମ୍ଭ_କରିବା(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vଲେଖିବା(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vପଢ଼ିବା() uint8 {
...
func (self *TPort16Bit) Vଆରମ୍ଭ_କରିବା(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vଲେଖିବା(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vପଢ଼ିବା() uint16 {
...
func (self *TPort32Bit) Vଆରମ୍ଭ_କରିବା(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vଲେଖିବା(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vପଢ଼ିବା() {
