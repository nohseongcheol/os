...
type IWidget interface {
	Vଆରମ୍ଭ_କରିବା(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
...
func (self *TWidget) Vଆରମ୍ଭ_କରିବା(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) ModelToScreen(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vଆରମ୍ଭ_କରିବା(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.ModelToScreen(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.ModelToScreen(uint32(xPos), uint32(yPos))
