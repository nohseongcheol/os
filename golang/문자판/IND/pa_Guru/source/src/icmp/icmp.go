...
func (self *TInternetControlMessageProtocolMessage) Vਆਰੰਭ_ਕਰਨਾ(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TICMPHandler) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, ਆਕਾਰ uint32) bool {
	return icmp.OnInternetProtocolReceived(srcIP_BE, dstIP_BE, dataPointer, ਆਕਾਰ)
}
...
func (self *TInternetControlMessageProtocol) Vਆਰੰਭ_ਕਰਨਾ(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vਆਰੰਭ_ਕਰਨਾ(backend, handler, 0x01)
	icmp = self
}
func (self *TInternetControlMessageProtocol) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, ਆਕਾਰ uint32) bool {
	if ਆਕਾਰ < uint32(icmpSize) {
		return false
	}
