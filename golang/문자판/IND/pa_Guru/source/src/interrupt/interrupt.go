...
func (self *TInterruptHandler) Vਆਰੰਭ_ਕਰਨਾ(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vਆਰੰਭ_ਕਰਨਾ(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	ਆਕਾਰ := (*uint16)(Pointer(&idtPointer[0]))
	(*ਆਕਾਰ) = (uint16)(Sizeof(idtData) - 1)
