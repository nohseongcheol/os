...
TEXT ·인터럽트요청처리0x00(SB),NOSPLIT,$0
	interrupt_handler(0x20)	
	

TEXT ·인터럽트요청처리0x01(SB),NOSPLIT,$0
	MOVB $0x4B, 0xB8068; 	 // char 'K'
	interrupt_handler(0x21)
	

TEXT ·인터럽트요청처리0x02(SB),NOSPLIT,$0
	interrupt_handler(0x22)
	

TEXT ·인터럽트요청처리0x03(SB),NOSPLIT,$0
	interrupt_handler(0x23)
	

TEXT ·인터럽트요청처리0x04(SB),NOSPLIT,$0
	interrupt_handler(0x24)
	

TEXT ·인터럽트요청처리0x05(SB),NOSPLIT,$0
	interrupt_handler(0x25)
	

TEXT ·인터럽트요청처리0x06(SB),NOSPLIT,$0
	interrupt_handler(0x26)
	

TEXT ·인터럽트요청처리0x07(SB),NOSPLIT,$0
	interrupt_handler(0x27)
	

TEXT ·인터럽트요청처리0x08(SB),NOSPLIT,$0
	interrupt_handler(0x28)
	

TEXT ·인터럽트요청처리0x09(SB),NOSPLIT,$0
	interrupt_handler(0x29)
	

TEXT ·인터럽트요청처리0x0A(SB),NOSPLIT,$0
	interrupt_handler(0x2A)
	

TEXT ·인터럽트요청처리0x0B(SB),NOSPLIT,$0
	interrupt_handler(0x2B)
	

TEXT ·인터럽트요청처리0x0C(SB),NOSPLIT,$0
	interrupt_handler(0x2C)
	

TEXT ·인터럽트요청처리0x0D(SB),NOSPLIT,$0
	interrupt_handler(0x2D)
	

TEXT ·인터럽트요청처리0x0E(SB),NOSPLIT,$0
	// Hardware IRQ14 does not push a CPU exception error code.
	interrupt_handler(0x2E)

TEXT ·인터럽트요청처리0x0F(SB),NOSPLIT,$0
	interrupt_handler(0x0F)

TEXT ·인터럽트요청처리0x80(SB),NOSPLIT,$0
	interrupt_handler(0x80)

TEXT ·인터럽트요청처리0x81(SB),NOSPLIT,$0
	interrupt_handler(0x81)

TEXT ·인터럽트요청처리0x82(SB),NOSPLIT,$0
...
TEXT ·인터럽트예외처리기0x00(SB),NOSPLIT,$0
	interrupt_exception(0x00)	

TEXT ·인터럽트예외처리기0x01(SB),NOSPLIT,$0
	interrupt_exception(0x01)	

TEXT ·인터럽트예외처리기0x02(SB),NOSPLIT,$0
	interrupt_exception(0x02)	

TEXT ·인터럽트예외처리기0x03(SB),NOSPLIT,$0
	interrupt_exception(0x03)	

TEXT ·인터럽트예외처리기0x04(SB),NOSPLIT,$0
	interrupt_exception(0x04)	

TEXT ·인터럽트예외처리기0x05(SB),NOSPLIT,$0
	interrupt_exception(0x05)	

TEXT ·인터럽트예외처리기0x06(SB),NOSPLIT,$0
	interrupt_exception(0x06)	

TEXT ·인터럽트예외처리기0x07(SB),NOSPLIT,$0
	interrupt_exception(0x07)	

TEXT ·인터럽트예외처리기0x08(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x08)	

TEXT ·인터럽트예외처리기0x09(SB),NOSPLIT,$0
	interrupt_exception(0x09)	

TEXT ·인터럽트예외처리기0x0A(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0A)	

TEXT ·인터럽트예외처리기0x0B(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0B)	

TEXT ·인터럽트예외처리기0x0C(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0C)	

TEXT ·인터럽트예외처리기0x0D(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0D)	

TEXT ·인터럽트예외처리기0x0E(SB),NOSPLIT,$0
...
TEXT ·인터럽트예외처리기0x0F(SB),NOSPLIT,$0
	interrupt_exception(0x0F)	

TEXT ·인터럽트예외처리기0x10(SB),NOSPLIT,$0
	interrupt_exception(0x10)	

TEXT ·인터럽트예외처리기0x11(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x11)	

TEXT ·인터럽트예외처리기0x12(SB),NOSPLIT,$0
	interrupt_exception(0x12)	

TEXT ·인터럽트예외처리기0x13(SB),NOSPLIT,$0
	interrupt_exception(0x13)	

TEXT ·인터럽트무시하기(SB),NOSPLIT,$0
