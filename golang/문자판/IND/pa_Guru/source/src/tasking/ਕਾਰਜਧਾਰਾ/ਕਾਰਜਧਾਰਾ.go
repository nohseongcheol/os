...
func (self *TThreadHelper) Vਆਰੰਭ_ਕਰਨਾ(mem *mem.TMemoryManager) {
	self.mem = mem
	콘솔.M출력XY(([]byte)("thread:"), 1, 14)
}
func (self *TThreadHelper) CreateFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) Tਕਾਰਜਧਾਰਾ {
	result := Tਕਾਰਜਧਾਰਾ{}
...
func (self *TThreadHelper) CreatePtrFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) *Tਕਾਰਜਧਾਰਾ {
	result := (*Tਕਾਰਜਧਾਰਾ)(self.mem.Malloc(uint32(Sizeof(Tਕਾਰਜਧਾਰਾ{}))))
	if result == nil {
		return nil
	}
