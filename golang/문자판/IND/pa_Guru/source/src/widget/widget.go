...
type IWidget interface {
	Vਆਰੰਭ_ਕਰਨਾ(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
...
func (self *TWidget) Vਆਰੰਭ_ਕਰਨਾ(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidgetMouseEventHandler) Vਆਰੰਭ_ਕਰਨਾ(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
