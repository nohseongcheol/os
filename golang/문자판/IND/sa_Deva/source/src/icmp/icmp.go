...
func (self *TInternetControlMessageProtocolMessage) Vप्रारम्भः(buffer TInternetControlMessageProtocolMessageBuffer) {
...
func (self *TICMPHandler) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, आकारः uint32) bool {
	return icmp.OnInternetProtocolReceived(srcIP_BE, dstIP_BE, dataPointer, आकारः)
}
...
func (self *TInternetControlMessageProtocol) Vप्रारम्भः(backend TInternetProtocolProvider, handler IInternetProtocolHandler) {
	ipHandler = handler
	ipHandler.Vप्रारम्भः(backend, handler, 0x01)
	icmp = self
}
func (self *TInternetControlMessageProtocol) OnInternetProtocolReceived(srcIP_BE uint32, dstIP_BE uint32, dataPointer uintptr, आकारः uint32) bool {
	if आकारः < uint32(icmpSize) {
		return false
	}
