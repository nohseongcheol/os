...
func (self *TPort8Bit) Vप्रारम्भः(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vलेखनम्(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vपठनम्() uint8 {
...
func (self *TPort16Bit) Vप्रारम्भः(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vलेखनम्(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vपठनम्() uint16 {
...
func (self *TPort32Bit) Vप्रारम्भः(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vलेखनम्(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vपठनम्() {
