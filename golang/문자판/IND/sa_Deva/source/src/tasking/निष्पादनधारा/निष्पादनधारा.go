...
func (self *TThreadHelper) Vप्रारम्भः(mem *mem.TMemoryManager) {
	self.mem = mem
	콘솔.M출력XY(([]byte)("thread:"), 1, 14)
}
func (self *TThreadHelper) CreateFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) Tनिष्पादनधारा {
	result := Tनिष्पादनधारा{}
...
func (self *TThreadHelper) CreatePtrFromFunction(entrypoint func(), PageDirEntry uint32, isKernel bool) *Tनिष्पादनधारा {
	result := (*Tनिष्पादनधारा)(self.mem.Malloc(uint32(Sizeof(Tनिष्पादनधारा{}))))
	if result == nil {
		return nil
	}
