...
func PrintBytes(dataPointer uintptr, आकारः int) {
...
func GetUintptrArrayFromPtr(सङ्केतसन्दर्भः_2 uintptr, len int, cap int) []uintptr {
	len = len * 4
	cap = cap * 4
	var sl = struct {
		addr	uintptr
		len	int
		cap	int
	}{सङ्केतसन्दर्भः_2, len, cap}
	return *(*[]uintptr)(Pointer(&sl))
}
func GetUint32ArrayFromPtr(सङ्केतसन्दर्भः_2 uintptr, len int, cap int) []uint32 {
	len = len * 4
	cap = cap * 4
	var sl = struct {
		addr	uintptr
...
func GetBytesFromPtr(सङ्केतसन्दर्भः_2 uintptr, len int, cap int) []byte {
	var sl = struct {
		addr	uintptr
		len	int
		cap	int
...
func GetFuncPtrFromPtr(सङ्केतसन्दर्भः_2 uintptr) func() {
	code1ptr := uintptr(Pointer(&सङ्केतसन्दर्भः_2))
