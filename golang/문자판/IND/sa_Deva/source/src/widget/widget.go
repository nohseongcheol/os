...
type IWidget interface {
	Vप्रारम्भः(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
...
func (self *TWidget) Vप्रारम्भः(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidgetMouseEventHandler) Vप्रारम्भः(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
