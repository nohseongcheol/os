...
ssize_t পাড়হাও(int fd, void *buf, size_t count)
{
    return (ssize_t)__syscall_result(SC3(SYS_পাড়হাও, fd, buf, count));
}

ssize_t অল(int fd, const void *buf, size_t count)
{
    return (ssize_t)__syscall_result(SC3(SYS_অল, fd, buf, count));
}
