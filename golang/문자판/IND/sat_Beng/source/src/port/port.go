...
func (self *TPort8Bit) Vঅল(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vপাড়হাও() uint8 {
...
func (self *TPort16Bit) Vঅল(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vপাড়হাও() uint16 {
...
func (self *TPort32Bit) Vঅল(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vপাড়হাও() {
