...
func (self *TPort8Bit) Vओल(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vपाड़हाव() uint8 {
...
func (self *TPort16Bit) Vओल(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vपाड़हाव() uint16 {
...
func (self *TPort32Bit) Vओल(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vपाड़हाव() {
