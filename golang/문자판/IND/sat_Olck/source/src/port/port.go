...
func (self *TPort8Bit) Vᱚᱞ(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vᱯᱟᱲᱦᱟᱣ() uint8 {
...
func (self *TPort16Bit) Vᱚᱞ(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vᱯᱟᱲᱦᱟᱣ() uint16 {
...
func (self *TPort32Bit) Vᱚᱞ(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vᱯᱟᱲᱦᱟᱣ() {
