...
func (self *TPort8Bit) Vلکڻ(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vپڙهڻ() uint8 {
...
func (self *TPort16Bit) Vلکڻ(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vپڙهڻ() uint16 {
...
func (self *TPort32Bit) Vلکڻ(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vپڙهڻ() {
