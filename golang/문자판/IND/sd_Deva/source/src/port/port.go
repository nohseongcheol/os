...
func (self *TPort8Bit) Vलिखणु(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vपढ़णु() uint8 {
...
func (self *TPort16Bit) Vलिखणु(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vपढ़णु() uint16 {
...
func (self *TPort32Bit) Vलिखणु(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vपढ़णु() {
