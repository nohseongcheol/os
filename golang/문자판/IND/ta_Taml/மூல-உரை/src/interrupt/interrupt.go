...
func (self *TInterruptHandler) Vதொடங்கு(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vதொடங்கு(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	அளவு := (*uint16)(Pointer(&idtPointer[0]))
	(*அளவு) = (uint16)(Sizeof(idtData) - 1)
