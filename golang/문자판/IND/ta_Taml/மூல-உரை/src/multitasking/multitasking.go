...
func (self *TTask) Vதொடங்கு(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vநினைவகத்தை_ஒதுக்கு(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
