...
func (self *TPort8Bit) Vதொடங்கு(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vஎழுது(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vபடி() uint8 {
...
func (self *TPort16Bit) Vதொடங்கு(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vஎழுது(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vபடி() uint16 {
...
func (self *TPort32Bit) Vதொடங்கு(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vஎழுது(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vபடி() {
