...
type IWidget interface {
	Vதொடங்கு(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vஉள்ளக_ஆயங்களை_அமை(x int32, y int32)
...
func (self *TWidget) Vதொடங்கு(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vஉள்ளக_ஆயங்களை_அமை(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vதொடங்கு(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vஉள்ளக_ஆயங்களை_அமை(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vஉள்ளக_ஆயங்களை_அமை(uint32(xPos), uint32(yPos))
