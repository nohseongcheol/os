...
func (self *TTask) Vప్రారంభించు(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vజ్ఞాపకస్థలాన్ని_కేటాయించు(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
