...
func (self *TPort8Bit) Vప్రారంభించు(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vరాయి(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vచదువు() uint8 {
...
func (self *TPort16Bit) Vప్రారంభించు(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vరాయి(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vచదువు() uint16 {
...
func (self *TPort32Bit) Vప్రారంభించు(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vరాయి(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vచదువు() {
