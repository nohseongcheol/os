...
type IWidget interface {
	Vప్రారంభించు(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32)
	GetFocus(widget IWidget)
	Vస్థానిక_నిర్దేశాంకాలను_అమర్చు(x int32, y int32)
...
func (self *TWidget) Vప్రారంభించు(parent IWidget, x uint32, y uint32, w uint32, h uint32, r uint32, g uint32, b uint32) {
...
func (self *TWidget) Vస్థానిక_నిర్దేశాంకాలను_అమర్చు(x uint32, y uint32) {
	if self.parent != nil {
...
func (self *TWidgetMouseEventHandler) Vప్రారంభించు(widget TWidget, vga TVideoGraphicsArray) {
	mouseWidget = widget
	mouseVGA = vga
}
func (self *TWidgetMouseEventHandler) OnMouseDown(button int8) {

	mouseWidget.Vస్థానిక_నిర్దేశాంకాలను_అమర్చు(uint32(prevX), uint32(prevY))
...
func (self *TWidgetMouseEventHandler) OnMouseMove(x int8, y int8) {
	...
	mouseWidget.Vస్థానిక_నిర్దేశాంకాలను_అమర్చు(uint32(xPos), uint32(yPos))
