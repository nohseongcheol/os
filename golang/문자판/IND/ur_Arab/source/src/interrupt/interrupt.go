...
func (self *TInterruptHandler) Vآغاز_کرنا(InterruptNumber uint8, InterruptManager uintptr, func_addr uintptr) {
...
func (self *TInterruptManager) Vآغاز_کرنا(hardwareInterruptOffset uint16, globalDescriptorTable *T공용서술자테이블, taskManager *T작업관리자) {
	...
	حجم := (*uint16)(Pointer(&idtPointer[0]))
