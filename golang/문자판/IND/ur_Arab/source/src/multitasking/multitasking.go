...
func (self *TTask) Vآغاز_کرنا(gdt *T공용서술자테이블, mem *mem.TMemoryManager, entrypoint func()) {

	self.cpustate = (*TCPUState)(Pointer(uintptr(mem.Vحافظہ_مختص_کرنا(1024*1024)) + 1024*1024 - Sizeof(TCPUState{})))
