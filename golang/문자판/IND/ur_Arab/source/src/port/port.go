...
func (self *TPort8Bit) Vآغاز_کرنا(portnumber uint16) {
	self.portnumber = portnumber
	self.read_count = 65
	self.write_count = 65
}
func (self *TPort8Bit) Vلکھنا(data uint8) {
	PortOutByte(self.portnumber, data)
}
func (self *TPort8Bit) Vپڑھنا() uint8 {
...
func (self *TPort16Bit) Vآغاز_کرنا(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort16Bit) Vلکھنا(data uint16) {
	PortOutWord(self.TPort.portnumber, data)
}
func (self *TPort16Bit) Vپڑھنا() uint16 {
...
func (self *TPort32Bit) Vآغاز_کرنا(portnumber uint16) {
	self.TPort.portnumber = portnumber
}
func (self *TPort32Bit) Vلکھنا(data uint32) {
	PortOutDword(self.TPort.portnumber, data)
}
func (self *TPort32Bit) Vپڑھنا() {
