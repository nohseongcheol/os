...
TEXT ·Hとってわりこみ(SB),NOSPLIT,$0-10
	...
	LEAQ ·わりこみげーとentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchわりこみ(SB),NOSPLIT,$0
...
TEXT ·わりこみげーとentry(SB),NOSPLIT,$0
