...
TEXT ·jumpゆーざーもーどiret(SB),NOSPLIT,$0
	...
	IRETL
TEXT ·jumpユーザーモードiret1(SB),NOSPLIT,$0
	RET

TEXT ·すれっどしゅうりょうloop(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD
