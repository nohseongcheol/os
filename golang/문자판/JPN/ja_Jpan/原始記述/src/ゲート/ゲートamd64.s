...
TEXT ·H取っ手割込み(SB),NOSPLIT,$0-10
	...
	LEAQ ·割込みゲートentry(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
