...
freestanding library in `./利用者領域/posix`.
...
`-I./利用者領域/posix/宣言集` and link the archive into an EngOS i386 user
...
`./利用者領域/posix/TEST_RESULTS.md`. Build all runtime test executables
