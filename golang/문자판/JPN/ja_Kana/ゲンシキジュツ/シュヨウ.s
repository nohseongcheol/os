...
TEXT ·Getcr4(SB),NOSPLIT,$0
	...
	MOVL AX, ret+0(FP)
	RET
TEXT ·Enableページカンリ(SB),NOSPLIT,$0
    MOVL CR0, AX
    ORL $0x80000001, AX
    MOVL AX, CR0
    RET
