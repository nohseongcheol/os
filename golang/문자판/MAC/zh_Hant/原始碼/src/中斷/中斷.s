...
TEXT ·halt之後fatalexception(SB),NOSPLIT,$0
	CLI
fatal_exception_halt:
	BYTE $0xF4 // HLT
	JMP fatal_exception_halt

TEXT ·設定ds(SB),NOSPLIT,$0
    MOVL ds_segment+0(FP), AX
    MOVW AX, DS
    RET

TEXT ·設定gs(SB),NOSPLIT,$0
...
TEXT ·中斷requesthandler0x00(SB),NOSPLIT,$0
	interrupt_handler(0x20)	
	

TEXT ·中斷requesthandler0x01(SB),NOSPLIT,$0
	MOVB $0x4B, 0xB8068; 	 // char 'K'
	interrupt_handler(0x21)
	

TEXT ·中斷requesthandler0x02(SB),NOSPLIT,$0
	interrupt_handler(0x22)
	

TEXT ·中斷requesthandler0x03(SB),NOSPLIT,$0
	interrupt_handler(0x23)
	

TEXT ·中斷requesthandler0x04(SB),NOSPLIT,$0
	interrupt_handler(0x24)
	

TEXT ·中斷requesthandler0x05(SB),NOSPLIT,$0
	interrupt_handler(0x25)
	

TEXT ·中斷requesthandler0x06(SB),NOSPLIT,$0
	interrupt_handler(0x26)
	

TEXT ·中斷requesthandler0x07(SB),NOSPLIT,$0
	interrupt_handler(0x27)
	

TEXT ·中斷requesthandler0x08(SB),NOSPLIT,$0
	interrupt_handler(0x28)
	

TEXT ·中斷requesthandler0x09(SB),NOSPLIT,$0
	interrupt_handler(0x29)
	

TEXT ·中斷requesthandler0x0a(SB),NOSPLIT,$0
	interrupt_handler(0x2A)
	

TEXT ·中斷requesthandler0x0b(SB),NOSPLIT,$0
	interrupt_handler(0x2B)
	

TEXT ·中斷requesthandler0x0c(SB),NOSPLIT,$0
	interrupt_handler(0x2C)
	

TEXT ·中斷requesthandler0x0d(SB),NOSPLIT,$0
	interrupt_handler(0x2D)
	

TEXT ·中斷requesthandler0x0e(SB),NOSPLIT,$0
	// Hardware IRQ14 does not push a CPU exception error code.
	interrupt_handler(0x2E)

TEXT ·中斷requesthandler0x0f(SB),NOSPLIT,$0
	interrupt_handler(0x0F)

TEXT ·中斷requesthandler0x80(SB),NOSPLIT,$0
	interrupt_handler(0x80)

TEXT ·中斷requesthandler0x81(SB),NOSPLIT,$0
	interrupt_handler(0x81)

TEXT ·中斷requesthandler0x82(SB),NOSPLIT,$0
...
TEXT ·I中斷啟用(SB),NOSPLIT,$0
	STI
	RET

TEXT ·I中斷deactive(SB),NOSPLIT,$0
	CLI
	RET

TEXT ·中斷exceptionhandler0x00(SB),NOSPLIT,$0
	interrupt_exception(0x00)	

TEXT ·中斷exceptionhandler0x01(SB),NOSPLIT,$0
	interrupt_exception(0x01)	

TEXT ·中斷exceptionhandler0x02(SB),NOSPLIT,$0
	interrupt_exception(0x02)	

TEXT ·中斷exceptionhandler0x03(SB),NOSPLIT,$0
	interrupt_exception(0x03)	

TEXT ·中斷exceptionhandler0x04(SB),NOSPLIT,$0
	interrupt_exception(0x04)	

TEXT ·中斷exceptionhandler0x05(SB),NOSPLIT,$0
	interrupt_exception(0x05)	

TEXT ·中斷exceptionhandler0x06(SB),NOSPLIT,$0
	interrupt_exception(0x06)	

TEXT ·中斷exceptionhandler0x07(SB),NOSPLIT,$0
	interrupt_exception(0x07)	

TEXT ·中斷exceptionhandler0x08(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x08)	

TEXT ·中斷exceptionhandler0x09(SB),NOSPLIT,$0
	interrupt_exception(0x09)	

TEXT ·中斷exceptionhandler0x0a(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0A)	

TEXT ·中斷exceptionhandler0x0b(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0B)	

TEXT ·中斷exceptionhandler0x0c(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0C)	

TEXT ·中斷exceptionhandler0x0d(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x0D)	

TEXT ·中斷exceptionhandler0x0e(SB),NOSPLIT,$0
...
TEXT ·中斷exceptionhandler0x0f(SB),NOSPLIT,$0
	interrupt_exception(0x0F)	

TEXT ·中斷exceptionhandler0x10(SB),NOSPLIT,$0
	interrupt_exception(0x10)	

TEXT ·中斷exceptionhandler0x11(SB),NOSPLIT,$0
	interrupt_exception_errorcode(0x11)	

TEXT ·中斷exceptionhandler0x12(SB),NOSPLIT,$0
	interrupt_exception(0x12)	

TEXT ·中斷exceptionhandler0x13(SB),NOSPLIT,$0
	interrupt_exception(0x13)	

TEXT ·中斷ignore(SB),NOSPLIT,$0
	MOVB $0x4D, 0xB8048 // char 'M'
	IRETL;

TEXT ·中斷離開迴圈(SB),NOSPLIT,$0
	STI
	BYTE $0xF4
	BYTE $0xEB; BYTE $0xFD

TEXT ·設定cr3(SB),NOSPLIT,$0
        MOVL cr3+0(FP), AX
        MOVL AX, CR3
        RET
