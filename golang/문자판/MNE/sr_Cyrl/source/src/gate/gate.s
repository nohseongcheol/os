...
TEXT ·инсталирајidt(SB),NOSPLIT,$0
...
// used).
TEXT ·РучкаОметање(SB),NOSPLIT,$0-10
	...
	LEAQ ·ометањеgateунос(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchОметање(SB),NOSPLIT,$0
...
TEXT ·ометањеgateунос(SB),NOSPLIT,$0
