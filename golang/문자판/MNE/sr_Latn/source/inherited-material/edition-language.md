# Montenegro (MNE) source language

- country: Montenegro (ME)
- selected language: sr_Latn
- CLDR population: 100%
- official status: official
- native language name: српски
- target-language vocabulary: 269
- unresolved source-glossary vocabulary: 602
