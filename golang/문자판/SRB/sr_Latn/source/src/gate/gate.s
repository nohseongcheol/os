...
GLOBL ·иБtDescriptor<>(SB), NOPTR, $10
...
// [12 - 15] reserved
GLOBL ·иБt<>(SB), NOPTR, $NUM_IDT_ENTRIES*IDT_ENTRY_SIZE
...
// used).
TEXT ·RučkaOmetanje(SB),NOSPLIT,$0-10
	...
	LEAQ ·ometanjegateunos(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
...
//--------------------------- -----------------------------------------
TEXT ·dispatchOmetanje(SB),NOSPLIT,$0
...
TEXT ·ometanjegateunos(SB),NOSPLIT,$0
