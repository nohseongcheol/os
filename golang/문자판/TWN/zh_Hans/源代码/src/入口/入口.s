...
TEXT ·H控制器中断(SB),NOSPLIT,$0-10
	...
	LEAQ ·中断入口条目(SB), SI // SI points to entry for trap 0
check_next_entry:
	TESTB CX, CX
	JZ update_idt_entry
